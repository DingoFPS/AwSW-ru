...
translate russiantl strings:
    ...
    new "Статус: {b}впечатлён{/b}\nЭпизодов сыграно: {b}[remyscenesfinished]{/b}"

    # status.rpy:45
    old "Status: {b}Bad{/b}\nScenes played: {b}[remyscenesfinished]{/b}"
    new "Статус: {b}плохой{/b}\nЭпизодов сыграно: {b}[remyscenesfinished]{/b}"

    # status.rpy:50
    old "Status: {b}Abandoned{/b}\nScenes played: {b}[remyscenesfinished]{/b}"
    new "Статус: {b}покинут{/b}\nЭпизодов сыграно: {b}[remyscenesfinished]{/b}"

    # status.rpy:61
    old "Status: {b}--{/b}\nScenes played: {b}[annascenesfinished]{/b}"
    new "Статус: {b}--{/b}\nЭпизодов сыграно: {b}[annascenesfinished]{/b}"
    ...
    # status.rpy:91
    old "Status: {b}Abandoned{/b}\nScenes played: {b}[annascenesfinished]{/b}"
    new "Статус: {b}покинута{/b}\nЭпизодов сыграно: {b}[annascenesfinished]{/b}"

    # status.rpy:102
    old "Status: {b}--{/b}\nScenes played: {b}[loremscenesfinished]{/b}"
    new "Статус: {b}--{/b}\nЭпизодов сыграно: {b}[loremscenesfinished]{/b}"
    ...
    new "Статус: {b}--{/b}\nЭпизодов сыграно: {b}[brycescenesfinished]{/b}"
    ...
    new "Статус: {b}--{/b}\nЭпизодов сыграно: {b}[adinescenesfinished]{/b}"
