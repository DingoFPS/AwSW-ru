# TODO: Translation updated at 2017-05-02 21:12

# game/chapter1.rpy:56
translate russiantl nameentryx_dc71aba9:

    # s "Detecting user profile.{cps=2}..{/cps}{w=2.0}{nw}"
    s "Поиск профиля пользователя.{cps=2}..{/cps}{w=2.0}{nw}"

# game/chapter1.rpy:94
translate russiantl nameentryx_058ab5bf:
...
translate russiantl colormenu1_e933acee:
    ...
    s "Выберите цвет." nointeract

# game/chapter1.rpy:163
translate russiantl colormenu2_e933acee:

    # s "Choose a color." nointeract
    s "Выберите цвет." nointeract

# game/chapter1.rpy:226
translate russiantl colormenu3_e933acee:

    # s "Choose a color." nointeract
    s "Выберите цвет." nointeract

# game/chapter1.rpy:289
translate russiantl colormenu4_e933acee:

    # s "Choose a color." nointeract
    s "Выберите цвет." nointeract

# game/chapter1.rpy:368
translate russiantl detected_bc6e30f8:

    # s "Welcome back, [player_name]."
    s "Добро пожаловать назад, [player_name]."

# game/chapter1.rpy:370
translate russiantl detected_84b78b40:

    # c "(Does this look right?)" nointeract
    c "(Желаете продолжить?)" nointeract

# game/chapter1.rpy:378
translate russiantl detected_263f7f4c:

    # s "User profile confirmed."
    s "Профиль пользователя подтверждён."

# game/chapter1.rpy:382
translate russiantl detected_bd29307b:
...
translate russiantl detected_b55f0cf7:
    ...
    "Управление\nИспользуйте [[Left Click] или [[Enter], чтобы листать текст, и для подтверждения выбора.\nНажмите [[Space], чтобы только перейти к следующему диалогу. Это полезно, чтобы случайно не выбрать ответ по ошибке."
...
translate russiantl detected_979415d0:
    ...
    "[[ESC] или [[ПКМ] открывает меню.\n[[F] переключает полноэкранный режим.\nИспользуйте [[Колесико мыши], или [[Page Up] и [[Page Down] чтобы посмотреть прошлые сообщения и перемотать."
...
translate russiantl colorend_b55f0cf7:
    ...
    # "Controls\nUse [[Left Click] or [[Enter] to advance text and select menu options.\nPress [[Space] to advance text only. This is useful to avoid making a selection by mistake."
    "Управление\nИспользуйте [[ЛКМ] или [[Enter] чтобы листать текст и выбирать пункты меню.\nНажмите [[Пробел] чтобы просто листнуть текст. Это полезно, чтобы не совершить неправильный выбор по ошибке."
...
translate russiantl begingame_02e25085:
    ...
    n "Лишь недавно человечество открыло портал, ведущий в иной мир. В мир, населенный расой разумных, говорящих драконов. Я был одним из тех немногих, кому удалось отправиться в этот мир..."

# game/chapter1.rpy:423
translate russiantl begingame_ef5e9be2:

    # n "...but, maybe, I should start at the beginning..."
    n "...но, может быть, я должен начать с самого начала..."
...
translate russiantl begingame_c9f110ae:
    ...
    n "Всё началось с того момента, как мы нашли странное устройство посреди глуши во время одной из наших экспедиций... это был портал."
...
translate russiantl begingame_f32d817d:
    ...
    n "Ранее я слышал о похожей технологии, хотя эта выглядела более экспериментальной. Я знал о том, что другие порталы, созданные в прошлом, предполагались для массового использования. Что насчёт этого портала - мы не знали ни кто его построил, ни когда - или почему мы нашли его здесь, в этих дебрях. Что стало для нас ещё большим удивлением - тот факт, что он оказался... функционирующим."
...
translate russiantl begingame_337d015e:
    ...
    nvl clear
    n "После первых же испытаний мы обнаружили, что на другой стороне был кто-то, обладающий похожим порталом: наши попытки связаться через портал оказались успешными. Но затем мы выяснили, что были неспособны поддерживать питание машины слишком долго, и нам было необходимо действовать быстро." #TODO?
...
translate russiantl begingame_3dadd8d0:
    ...
    n "Один из нас вызвался почти сразу же."
...
translate russiantl begingame_f4966cae:
    ...
    n "Я знал его. Или, точнее, мы были знакомы в прошлом. Мы посещали одну и ту же школу, и нам даже посчастливилось побывать на нескольких занятиях вместе. Мы никогда не были очень близкими друзьями, но мы общались время от времени и, иногда, веселились в одних и тех же компаниях. Тем не менее, наши пути в конце концов разошлись." #TODO?
...
translate russiantl begingame_d966c5be:
    ...
    n "Я не был уверен, как реагировать на всё это. Но он был обязан знать, что делает. Он определенно был смелым." #TODO?

# game/chapter1.rpy:449
translate russiantl begingame_0be71cd9:

    # n "Either that, or just very, very foolish."
    n "Или просто же очень, очень глупым."
...
translate russiantl begingame_71b0a869:
    ...
    n "В то время, как я не был уверен какой из вариантов больше подходил, все восхищались его мужеством. В конце концов, он не мог знать наверняка, кто или что поджидает его на той стороне портала. Да и даже если бы он встретил кого-то там, то кто знает какие намерения у них могли быть?" #TODO?
...
translate russiantl begingame_11930bc6:
    ...
    n "С другой стороны, не то, чтобы какие-либо домыслы с нашей стороны могли бы что-то изменить." #TODO?
...
translate russiantl begingame_82f1d7da:
    ...
    nvl clear
    n "Обещанный день наконец наступил; аплодисменты с эхом разносились вокруг. Имея при себе лишь одежду, мульти-инструмент, пистолет и наручное устройство, заменяющее КПК, Реза отправился в иной мир." #TODO?
...
translate russiantl begingame_a929e4ad:
    ...
    n "Толпа аплодирующих начала рассеиваться, и энтузиазм со временем спал. Нам ничего не оставалось, кроме как ждать и предполагать, что случится дальше."
...
translate russiantl begingame_4e5d991b:
    ...
    n "Приблизительно через 8 часов мы получили наше первое сообщение от Резы."
...
translate russiantl begingame_2a8e54d7:
    ...
    n "Ситуация, описанная им, была такой странной и несвойственной, что сначала мы приняли её за шутку." #TODO?
...
translate russiantl begingame_bb325a0f:
    ...
    n "Стоит сказать, за очень плохую шутку, для которой было совсем не самое лучшее время." #TODO?
...
translate russiantl begingame_ac587ebf:
    ...
    nvl clear
    n "Однако, скоро стало ясно, что мы, возможно, только что сделали одно из самых важных открытий со времён рассвета человечества."
...
translate russiantl begingame_273be6cf:
    ...
    n "Даже просто найти портал - уже довольно выдающийся результат, но ситуация приобрела совершенно другой уровень."
...
translate russiantl begingame_942d3fc8:
    ...
    n "Из того, что он описывал об этом месте - или, более точно, его жителях - мы предположили, что оно вовсе не являлось частью Земли."
...
translate russiantl begingame_b4430af1:
    ...
    n "Мы назвали их {i}драконами{/i}, кем они были, исходя из описания Резы, или, по крайней мере, на кого они больше всего походили."
...
translate russiantl begingame_73af8ba0:
    ...
    n "Даже хотя нам было сложно поверить во всё это, именно эти драконы были теми, кто отправлял нам все послания. Реза нашёл на другой стороне портала целую циливизацию. Они умели говорить, писать книги, умели строить и обращаться с электричеством. Во многом, их общество действительно было очень похоже на человеческое."
...
translate russiantl begingame_1020ae93:
    ...
    n "Наши домыслы вели к заключению обратного. Ведь, в конечном итоге, мы знали о существовании тысяч планет, находящихся в миллионах световых годах от Земли и теоретически населённых живыми существами, но даже так: у нас по-прежнему не было убедительных подтверждений в пользу существования инородных форм жизни."
...
translate russiantl begingame_3ff6841f:
    ...
    n "Некоторые люди связывали открытие с квантовой механикой и параллельными вселенными, но в конце концов... Всё это являлось лишь догадками и абсолютно бесплодными предположениями, ведь у нас не было ни средств, ни ресурсов для более подробного изучения всех возможностей."
...
translate russiantl begingame_94c45763:
    ...
    nvl clear
    n "Думаю, стоит упомянуть ещё одну вещь перед тем, как я продолжу:"
...
translate russiantl begingame_dc6c4ac0:
    ...
    n "Они не знали о каких-либо других разумных формах жизни, их портал был найден лишь недавно, и технология была ранее им неизвестна. Так же, как у нас существовали мифы о драконах, у них существовали мифы о нас."
...
translate russiantl begingame_32508c0c:
    ...
    n "Вот что мы знали о них до настоящего момента. Изучение и обсуждение их культурного значения становилось всё интереснее, и мы не знали, к чему всё это приведет." #TODO?
...
translate russiantl begingame_26e2ea6a:
    ...
    n "Реза, по всей видимости, был уверен в том, что он делал. В итоге он дал нам знать, что они согласились на сделку."
...
translate russiantl begingame_23bd1b9f:
    ...
    n "В общем и целом, они не казались настолько технологически развитыми, как мы. Но они превосходили нас в кое-чём другом. Их средства выработки энергии были... возобновляемыми."
...
translate russiantl begingame_9422efc0:
    ...
    n "Кроме того, и довольно производительными. Нам бы определённо очень пригодилась такая технология. Всего лишь обменивая знания о прошлом человеческой расы, мы бы могли получить что-то более... ощутимое..."
...
translate russiantl begingame_c8829c2c:
    ...
    n "Именно здесь и начинается моя история." #TODO?
...
translate russiantl begingame_9cb37fb9:
    ...
    n "Мой предшествующий опыт в биологии и социологии мог бы пригодиться для доставки наших КПК устройств и последующего обмена. И тем временем, в мире драконов, ожидая изготовления ими прототипов наших генераторов, я бы играл роль представителя от имени человечества. "
...
translate russiantl begingame_a1d738a9:
    ...
    nvl clear
    n "Несмотря на то, какие мысли живые и разговаривающие драконы способны вызвать в умах многих людей, я даже и не подумал взять с собой средство самозащиты, надеясь на то, что они достаточно дружелюбны и миролюбивы."
...
translate russiantl begingame_01f41d60:
    ...
    n "Мне не нужно было опасаться потенциальных злонамеренных действий, о чём и думал Реза во время его перехода на неизвестную территорию. Действуя как посол от человечества, я обязан сделать всё возможное, чтобы поддерживать высокий уровень этих дипломатических отношений."
...
translate russiantl begingame_29ac0db6:
    ...
    n "Когда время пришло переступить через грань портала, вся моя умственная подготовка мигоим испарилась. Машина пряналась за работу, и множество вопросов, скрывавшихся в моей голове, начали всё сильнее меня волновать." #TODO?
...
translate russiantl begingame_1b21db5d:
    ...
    n "Кого я встречу на той стороне?"
...
translate russiantl begingame_8b5b997c:
    ...
    n "Что, если на самом деле они не так дружелюбны и заставили Резу написать эти послания. Что, если они создавали лишь видимость дружелюбия, чтобы заманить нас в логово монстров, пожирающих людей, и верной гибели, управляясь с нами как с вкусной послеобеденной закуской?"

# game/chapter1.rpy:512
translate russiantl begingame_605c857b:

    # n "Maybe I should've brought a weapon after all..."
    n "Может, в конечном итоге мне всё же стоило взять с собой оружие..." #TODO?
...
translate russiantl begingame_4ca759d4:
    ...
    n "{cps=80}Неожиданно, началась телепортация. Я почувствовал, как дрожь пробегает по всему телу. Как будто каждая клетка, каждый атом моего тела был оторван и отправлен в разных направлениях.{/cps}{nw}" #TODO?
...
translate russiantl begingame_3ba6854d:
    ...
    n "{cps=80}Безграничный космос, завораживающие картины звёзд. Изображения всего невиданного и несказанного за несколько мгновений пронеслись перед моими глазами.{/cps}{nw}" #TODO?
...
translate russiantl begingame_0d6baf11:
    ...
    n "{cps=80}Ужасающее и прекрасное слились воедино. Испытанное не было похоже ни на что другое, закончившись за долю секунды.{/cps}" #TODO?
...
translate russiantl begingame_9ea6cf05:
    ...
    n "Я мог разглядеть только пятно более светлого на фоне окружающего цвета. Моё зрение начало проясняться, и пятно медленно стало приобретать форму, похожую на голову рептилии со множеством рогов." #TODO?
...
translate russiantl holetravel_6a175cfd:
    ...
    m "Это был дракон!{w=1.0}\nИ как я теперь мог видеть, дракон, имеющий не только круглые очки, но также и галстук бордового цвета." #TODO?
...
translate russiantl holetravel_7941b5bd:
    ...
    Ry "От имени наших людей, я приветствую Вас. Позвольте представиться, я Реми, Ваш гид и посол - представитель нашего совета."
...
translate russiantl holetravel_b40dd6f0:
    ...
    m "Дракон мог говорить! Та вещь, о которой я читал и слышал, но... Он стоял прямо передо мной, во плоти и крови... и говорил. Хорошо, что вся моя подготовленность исчезла, когда я переместился в этот мир. Ничто не могло приготовить меня к такому." #TODO?
...
translate russiantl holetravel_5c6fb2e0:
    ...
    Ry "Приношу извинения. Я полагаю, у Вас могут по-прежнему проявляться эффекты телепортации. Сонливость и слабость вполне так же не необычны, как обморок и спонтанное опустошение кишечника, мочевого пузыря или живота. Как Вы чувствуете себя?"
...
translate russiantl holetravel_1b80444e:
    ...
    Ry "Что ж, я рад это слышать."

# game/chapter1.rpy:671
translate russiantl holetravel_a3fad319:

    # Ry "Maybe we should go before it gets too dark. Come with me, please."
    Ry "Может, нам стоит отправиться до того, как станет слишком темно. Прошу, следуйте за мной."
...
translate russiantl holetravel_91c5ac30:
    ...
    m "И я последовал за драконом. Солнце уже зашло за горизонт, и оставшийся свет исчез за считанные минуты. Я попытался не отставать слишком далеко." #TODO?

# game/chapter1.rpy:678
translate russiantl holetravel_98cf1cad:

    # c "It is getting hard to see where I'm going..."
    c "Мне становится всё сложнее разглядеть, куда я иду..."
...
translate russiantl holetravel_aeb0c88e:
    ...
    Ry "Простите насчёт этого, но у нас была хорошая причина для выбора такого времени. Мы не хотели, чтобы Вас застала толпа людей, поэтому нам пришлось сохранить точное время и дату прибытия в секрете."
...
translate russiantl holetravel_a75b3c45:
    ...
    Ry "Это ещё мягко сказано. Некоторые люди здесь довольно суеверны. Они могут счесть Вас или кого-то из вашего вида как... некоторым видом божества, полагаю."
...
translate russiantl holetravel_437d1607:
    ...
    Ry "У нас существуют определённые мифы, которые описывают людей как... О, думаю, урок истории должен подождать до следующего раза. Вот мы и здесь."
...
translate russiantl holetravel_6e0c5972:
    ...
    m "К этому моменту стало настолько темно, что я едва мог разглядеть здание впереди нас. На секунду я задумался, почему у них нет уличного освещения. Может, оно им просто не необходимо ввиду возможного развития зрения или способности ночного видения." #TODO?
...
translate russiantl holetravel_4bcd03cc:
    ...
    m "Я слабо видел дракона, но его светлые тона по-прежнему виднелись на фоне окружающих тёмных цветов. Я заметил, как он встал и открыл дверь с помощью одной из его передних лап."
...
translate russiantl holetravel_f97397b2:
    ...
    m "Издав протяжный скрип, дверь открылась. С лёгким щелчком выключателя комната заполнилась светом, ослепив меня после всего того времени, что я провёл без света."
...
translate russiantl holetravel_e590ac89:
    ...
    Ry "Становится довольно поздно, поэтому я должен покинуть Вас. В любом случае, кто-нибудь придёт и встретит вас завтрашним утром."
...
translate russiantl holetravel_0066f440:
    ...
    n "Я заметил движение снаружи. С некоторой осторожностью, я приблизился к окну и смог отчётливо услышать быстро отдаляющиеся шаги по траве. Предположив, что это был дракон, с которым я только что познакомился, я отбросил все плохие мысли и направился к кровати, постепенно поддавшись сладкому очарованию сна." #TODO?
...
translate russiantl holetravel_344cc935:
    ...
    n "Несколько минут я думал о своей роли, цели и о моём нахождении здесь и сейчас." #TODO?
...
translate russiantl holetravel_49a3a932:
    ...
    n "И вот он я, незнакомец в незнакомой стране. Я только начинал чувствовать лежавший на мне вес ответственности, давление своей задачи и ожидания, с которыми я обязательно столкнусь, представляя людей своего мира, культуру и циливизацию." # TODO?

# game/chapter1.rpy:744
translate russiantl holetravel_d92940c8:

    # n "So many would depend on it, yet I did not even know where the only human contact I had currently was."
    n "Столькое будет зависеть от меня. Но я даже не знал, какие способы связи с человечеством мне доступны на настоящий момент." # TODO?

# game/chapter1.rpy:745
translate russiantl holetravel_75a177a0:
...
translate russiantl holetravel_8355d8c5:
    ...
    n "Может, мне даже стоит написать книгу обо всём, с чем я столкнусь после того, как всё закончится. Уверен, что такая книга стала бы хитом."
...
translate russiantl holetravel_ed81ce8a:
    ...
    nvl clear
    n "Во всяком случае, это будет весело."

# game/chapter1.rpy:809
translate russiantl skipintro_4ceaddf2:

    # s "{cps=20}You wish to glimpse the past, [player_name]? Very well.{/cps}{cps=2}..{/cps}{w=2.0}{nw}"
    s "{cps=20}Желаешь взглянуть на прошлое, [player_name]? Ну, хорошо.{/cps}{cps=2}..{/cps}{w=2.0}{nw}"

# game/chapter1.rpy:813
translate russiantl skipintro_664c5cbc:

    # s "{cps=20}You wish to return once more, [player_name]? Very well.{/cps}{cps=2}..{/cps}{w=2.0}{nw}"
    s "{cps=20}Желаешь вернуться снова, [player_name]? Ну, хорошо.{/cps}{cps=2}..{/cps}{w=2.0}{nw}"

# game/chapter1.rpy:817
translate russiantl skipintro_bc457b13:

    # s "{cps=20}Continue your journey, [player_name].{/cps}{cps=2}..{/cps}{w=2.0}{nw}"
    s "{cps=20}Продолжай своё путешествие, [player_name].{/cps}{cps=2}..{/cps}{w=2.0}{nw}"

# game/chapter1.rpy:1132
translate russiantl seccont_76b2fe88:

    # nvl clear
    nvl clear

# game/chapter1.rpy:1147
translate russiantl seccont_f6acc4a0:
    ...
    n "Я проснулся от неприятных снов, глядя на непривычный потолок. На несколько секунд, я не мог понять, где я находился, но воспоминания событий прошлой ночи быстро вернулись ко мне." #TODO?
...
translate russiantl seccont_22affa1d:
    ...
    n "Хорошенько потянувшись, я окинул взором комнату, заполненную утренним солнечным светом. Снаружи, вдалеке, виднелся портал и гордо стоял на вершине небольшого холма - тот портал, через который я прибыл." # TODO?

# game/chapter1.rpy:1149
translate russiantl seccont_f69b9100:
    # Поставил "Вставая с кровати" (довольно хорошо подходит по действиям и звучанию). Убрал "Других потребностей", но можно на что-нибудь заменить
    ...
    n "Вставая с кровати, я заметил, что на столе что-то лежало. Записка от Реми, оставленная на случай, если мне что-то понадобится. Наряду с его собственным домашним и рабочим номерами, на ней были некоторые номера доставки еды, отделение неотложной помощи и даже уборочные сервисы. Он определённо продумал всё, хотя теперь меня не покидала мысль, как мог выглядеть дракон водопроводчик." #TODO

# game/chapter1.rpy:1153
translate russiantl seccont_b34a115e:

    # n "My musings were interrupted when the doorbell rang. When I opened the door, I was met by another dragon."
    n "Мои размышления были прерваны дверным звонком. Я открыл дверь, и меня встретил ещё один дракон."

# game/chapter1.rpy:1188
translate russiantl _call_skiptut_2_4d25d249:
    ...
    s "Мои записи зафиксировали, что вы уже прошли эту сцену удовлетворительным образом. Вы бы хотели пропустить её до выбора персонажей?" #TODO

# game/chapter1.rpy:1196
translate russiantl _call_skiptut_2_11989f6d:
...
translate russiantl _call_skiptut_2_e25f7eb3:
...
translate russiantl _call_skiptut_2_0054b77b:

    # s "As you wish.{cps=2}..{/cps}{w=1.0}{nw}"
    s "Как пожелаете.{cps=2}..{/cps}{w=1.0}{nw}"

# game/chapter1.rpy:1239
translate russiantl _call_skipcheck_2_0054b77b:
...
# 3 предложение пезда какаита | Сопровождением -> сопровождающим
    ...
    Sb "П-Приветствую! Вы, должно быть, [player_name]. Я Себастиан, и я буду вашим сопровождающим... и-или охраной, полагаю. Обычно я работаю на полицию, вот. Приятно познакомиться."

# game/chapter1.rpy:1259
translate russiantl _call_skipcheck_2_dd8ee6c6:
    # Сократил очень сильно текст
    ...
    m "Он выглядел намного меньше Реми и с некоторой нервозностью протянул ко мне свою руку. Он, по-видимому, ходит только на двух задних лапах, не имеющих выраженных пальцев." #TODO
...
translate russiantl _call_skipcheck_2_369fcd63:
    ...
    m "Я взял кисть его руки, чтобы осторожно её пожать, почуствовав заметные бугорки и неровности на грубой коже."
...
translate russiantl _call_skipcheck_2_7a25dc5e:
    ...
    c "Я тоже рад познакомиться, Себастиан. Итак, куда мы собираемся?" #TODO?

# game/chapter1.rpy:1268
translate russiantl _call_skipcheck_2_7a25dc5e_1:

    # c "Nice to meet you too, Sebastian. So, where are you taking me?"
    c "Я тоже рад познакомиться, Себастиан. Итак, куда мы собираемся"

# game/chapter1.rpy:1274
translate russiantl _call_skipcheck_2_540956bc:

    # m "When I took his hand into mine, preparing to kiss it, I could feel the individual bumps and scales on his rough skin."
    m "Я взял кисть его руки, готовясь поцеловать её, почувствовав отдельные бугорки и чешуйки на его грубой коже." #TODO?
...
translate russiantl _call_skipcheck_2_89d32851:
    ...
    Sb "Сразу к делу, да? Мы собираемся посетить завод, где собирают ваши генераторы. Я слышал, что у них есть какие-то новости для тебя." # TODO?

# game/chapter1.rpy:1285
translate russiantl _call_skipcheck_2_e6da4888:

    # Sb "Reza will be there, too."
    Sb "Реза, кстати, тоже будет там."

# game/chapter1.rpy:1286
translate russiantl _call_skipcheck_2_5a47fdba:

    # c "Sounds great."
    c "Звучит отлично." #TODO

# game/chapter1.rpy:1287
translate russiantl _call_skipcheck_2_cc9b257f:

    # Sb "Just follow me."
    Sb "Просто следуй за мной."

# game/chapter1.rpy:1295
translate russiantl _call_skipcheck_2_76b2fe88:
...
translate russiantl _call_skipcheck_2_a0f2016d:
    ...
    n "Мы вышли на улицу. Я был вполне уверен, что мы намеренно обходим более оживленные части города, блуждая по закоулкам и небольшим аллеям, чтобы не привлекать слишком много лишнего внимания." #TODO

# game/chapter1.rpy:1299
translate russiantl _call_skipcheck_2_04ea8b49:

    # n "Even then, we got the occasional stare."
    n "Но даже так, на нас периодически поглядывали со стороны."
...
translate russiantl _call_skipcheck_2_a313ff65:
    ...
    n "Всего лишь через пару минут мы прибыли к нужному месту, где нас встретил Реза. А также другой дракон - злобное на вид чудовище - , находясь на приличном расстоянии друг от друга." #TODO
...
translate russiantl _call_skipcheck_2_4e1f9793:
    ...
    c "Реза, сколько лет, сколько зим."
...
translate russiantl _call_skipcheck_2_035ee4c5:
    ...
    Rz "Это уж точно. Приятно в конце концов увидеть здесь другое человеческое лицо."
...
translate russiantl _call_skipcheck_2_ab689bf0:
    ...
    Rz "Какое невероятное совпадение встретиться здесь именно с тобой. "
...
translate russiantl _call_skipcheck_2_bf84f7f4:
    ...
    Rz "Просто мой телохранитель, как и твой. Не стоит беспокоить его, он не особо разговорчив."
...
translate russiantl _call_skipcheck_2_f80ab64c:
    ...
    m "Два дракона перекинулись парой слов. Находившись в нескольких шагах, большой, мрачный дракон взглянул в мою сторону. Себастиан повернулся ко мне и сказал." #TODO?
...
translate russiantl _call_skipcheck_2_dc037c95:
    ...
    Mv "Ага, конечно. Просто не жди от меня, как от других, какого-либо особого отношения к себе и всё будет хорошо."
...
translate russiantl _call_skipcheck_2_d732b21c:
    ...
    Mv "Ты хочешь сказать, что не заметил как одобрительно они на тебя пялятся, будто бы ты вестник новой эры?" # TODO?
...
translate russiantl _call_skipcheck_2_4f894d15:
    ...
    Rz "Мы, в отличие от вас, не создаём важного события с нашего обмена. Мы здесь только для получения того, на что мы согласились, и мы сразу же уйдём. Если уж на то пошло, я бы и вправду хотел, чтобы вы оставили нас наедине. Но именно ты настаиваешь на преследовании меня, куда бы я ни пошёл." # TODO
...
translate russiantl _call_skipcheck_2_bf0efca8:
    ...
    m "Дракон оскалил зубы на Резу, и из его трепещущей пасти вырвалось рычание." # TODO
    # Из трепещущей пасти дракона вырвалось рычание, только он оскалил зубы на Резу. / сильно поэтично? Немного
    # Убрал чёрной, заменил дрожащий на трепещущий
...
translate russiantl _call_skipcheck_2_9cffa3e3:
    ...
    Sb "Хорошо, хорошо, хватит уже вам. Давайте уже просто пройдем внутрь, идёт?" #TODO?
...
translate russiantl _call_skipcheck_2_0c52476d:
    ...
    # m "Проблем удалось избежать сразу же, как только мы вошли в здание. Изнутри помещение могло похвастаться множеством этажей, высокими потолками и длинными, узкими коридорами по которым Себастиан вёл нас к месту нашего назначения."
    m "Проблем удалось быстро избежать, и мы вошли в здание. Множество этажей, высокие потолки и длинные, узкие коридоры проносились перед нами тем временем, как Себастиан вёл нас к месту нашего назначения." #TODO?
...
translate russiantl _call_skipcheck_2_1e106597:
    ...
    Sb "Минуточку, я думал нас собирались встретить ребята из производства. Что ты делаешь здесь?"
...
translate russiantl _call_skipcheck_2_8c860b7d:
    ...
    "???" "Они прибудут сегодня чуть позже, поэтому вам придётся довольствоваться мною."
...
translate russiantl _call_skipcheck_2_46975328:
    ...
    Sb "Что ж, [player_name], это Анна. Она, вроде как, заведует этим зданием, хотя на самом деле она больше работает в исследовательском крыле, чем в производственном и инженерном." #TODO?
...
translate russiantl _call_skipcheck_2_e2ad732a:
    ...
    An "Весьма приятно. У меня есть кое-что для вас, кстати. Им понадобится некоторое время, чтобы собрать все обещанные генераторы, но здесь уже один подготовлен для вас. Вы вольны отправить его домой и провести тестирование." #TODO?
...
translate russiantl _call_skipcheck_2_83471fa0:
    ...
    c "Выглядит не очень большим." # TODO?
...
translate russiantl _call_skipcheck_2_71aa7402:
    ...
    An "Не недооценивай его мощь. О, и не уроните его по неосторожности." #TODO?
...
translate russiantl _call_skipcheck_2_6e8828ce:
    ...
    Rz "Конечно. Я буду ждать снаружи, пока ты тут занимаешься своими делами, [player_name]." #TODO?
...
translate russiantl _call_skipcheck_2_e93cdc3b:
    ...
    An "Прекрасно, теперь проверим эту штуковину..." # TODO?
...
translate russiantl _call_skipcheck_2_677e591a:
    ...
    m "Интерфейс КПК засветился в ответ на быстрые и рассчитанные движения её рук." #TODO?
...
translate russiantl _call_skipcheck_2_63d2793a:
    ...
    #An "Кстати, ты был бы не против, если бы я и у тебя взяла несколько анализов? Мне нужна всего лишь капля твоей крови." # TODO
    An "Кстати, ты был бы не против, если бы я провела и на тебе парочку тестов? Мне нужна всего лишь капля твоей крови." # TODO
    # Если бы я провела на тебе парочку тестов? Экспериментов?
...
translate russiantl _call_skipcheck_2_ff60882c:
    ...
    m "Она быстро достала небольшое устройство из ящика, которое на внешний вид во многом напоминало мне пробирку." #TODO?

# game/chapter1.rpy:1482
translate russiantl _call_skipcheck_2_4cb93198:

    # An "Now, if you would give me your hand, please."
    An "Теперь, если ты позволишь, подай мне свою руку, пожалуйста." # TODO?
...
translate russiantl _call_skipcheck_2_5bb6a80a:
    ...
    m "Она взяла мою руку и прижала устройство прямо в тыльную сторону руки. Я вздрогнул от боли, прошедшей через моё тело. Что-то острое прокололо мою кожу. Вскоре, капелька крови затянулась в трубку, соединённую с маленькой иглой." #TODO
#Я протянул ей руку, Она взяла меня за руку ухх бля
...
translate russiantl _call_syscheck_4_62f75a4e:
    ...
    s "Вы дали Анне свою кровь? Ну, хорошо...{image=image/ui/status/havetestresults.png}" #TODO
...
translate russiantl _call_syscheck_4_6ef34d2e:
    ...
    An "Похоже с вашим КПК всё хорошо. Кстати, мы почти закончили." #TODO? она имеет ввиду что она закончила брать у ГГ кровь.
...
translate russiantl _call_syscheck_4_efd29328:
    ...
    An "И раз мы оба разбираемся в биологии, то было бы интересно встретиться как-нибудь позже. Вот мой номер." #TODO блять?
...
translate russiantl _call_syscheck_4_6bc8260f:
    ...
    Rz "Я тоже. Ну, если мы собираемся позволить изучить наше тело, то почему бы не получить с этого выгоду, ведь так?"
...
translate russiantl _call_syscheck_4_ed80bfe0:
    ...
    Rz "Я всеми руками за. Терпеть не могу вставать так рано."
...
translate russiantl _call_syscheck_4_f6fea122:
    ...
    Sb "Никаких проблем. Неподалёку есть кафе. Что скажешь, Маверс?" #TODO?
...
translate russiantl _call_skiptut_3_65cc2485:
    ...
    s "Мои записи зафиксировали, что вы уже прошли эту сцену удовлетворительным образом. Вы бы хотели пропустить до начала расследования?"

# game/chapter1.rpy:1581
translate russiantl _call_skiptut_3_c0c1f01e:

    # s "It looks like you've seen this before. Skip to the investigation?"
    s "Похоже, вы уже видели это сцену ранее. Пропустить до расследования?"

# game/chapter1.rpy:1589
translate russiantl _call_skiptut_3_23afc6bb:
    ...
    s "Выходит, что вы уже видели это. Вы можете просмотреть эту сцену снова, или мы можем сэкономить немного времени и пропустить до расследования."

# game/chapter1.rpy:1603
translate russiantl _call_skiptut_3_0054b77b:

    # s "As you wish.{cps=2}..{/cps}{w=1.0}{nw}"
    s "Как пожелаете.{cps=2}..{/cps}{w=1.0}{nw}"

# game/chapter1.rpy:1618
translate russiantl _call_skipcheck_3_0054b77b:
...
translate russiantl _call_skipcheck_3_98a18a10:
    ...
    m "К счастью для нас, к нашему прибытию было ещё раннее время и кафе оказалось почти пустым. Реза быстро отвёл меня к столу на двоих, что вынудило драконов занять места в другой части ресторана." #TODO?
...
translate russiantl _call_skipcheck_3_bac0030c:
    ...
    Rz "Ух, наконец-то. Не мог терпеть, когда этот парень все время висит на моём хвосте." #всё это чёртово время." #TODO?

# game/chapter1.rpy:1629
translate russiantl _call_skipcheck_3_9bff7a4c:

    # Rz "I'm very much aware that is what they're saying."
    Rz "Я очень сомневаюсь в том, что они говорят." #TODO?
...
translate russiantl _call_skipcheck_3_600f3c23:
    ...
    m "К нам обратилась персона, по-видимому, официант кафе. Она являлась любопытным на вид драконом, и, в отличие от всех тех, кого я видел до этого - была скорее похожа на виверну, обладая двумя большими крыльями, представляющих её передние конечности и напоминающих огромную летучую мышь." # TODO
...
translate russiantl _call_skipcheck_3_beab5379:
    ...
    Ad "Добро пожаловать в наше заведение. Моё имя Эдин, и сегодня я буду вашей официанткой."
...
translate russiantl _call_skipcheck_3_5ea7a991:
    ...
    Ad "Конечно. Два омлета с беконом будут скоро готовы."
...
translate russiantl _call_skipcheck_3_cf34577b:
    ...
    Rz "Как я говорил, если ты посмотришь на картину в целом, тебе не кажется, что здесь что-то... не так с этим всем местом? Действительно, где же оно находится?"
...
translate russiantl _call_skipcheck_3_15dfbdc0:
    ...
    Rz "Если это предположительно совсем отдельное от Земли место или даже другое измерение, некоторые вещи просто не вписываются. Разве ты так не считаешь тоже?" #TODO?
...
translate russiantl _call_skipcheck_3_0fd8eb86:
    ...
    Rz "Я и вправду не могу сказать большего с сам-знаешь-кем здесь. Возможно, он прямо сейчас подслушивает нас." #TODO?
...
translate russiantl _call_skipcheck_3_ad30f800:
    ...
    m "Когда я обвёл взглядом кафе, я увидел, что Маверик смотрел в моём направлении. На небольшой момент наши глаза встретились, и его выражение не показывало никаких заметных эмоций. Я задался вопросом: было ли это просто случайностью, или он действительно способен слышать нас с такого расстояния."
...
translate russiantl _call_skipcheck_3_7b36bca9:
    ...
    Rz "Тсс, тише. Я дам тебе знать, как только смогу. Но пока, давай действовать по-отдельности. В конечном итоге, у нас уже есть один из этих деток." # TODO OOOОООООООООООООООООООООО
...
translate russiantl _call_skipcheck_3_b2abfd61:
    ...
    Rz "Бог знает, что мы нуждаемся в них." #TODO?
...
translate russiantl _call_skipcheck_3_bfc7dc06:
    ...
    m "Девушка вернулась, ошеломляя меня своей способностью удерживать блюда на краях крыльев. Она положила свою переднюю лапу на стол и начала перекладывать тарелки со своего крыла на стол аккуратными движениями своей мордочки."
...
translate russiantl _call_skipcheck_3_2f7cd978:
    ...
    Ad "Держите. Приятного аппетита!" # TODO bon appeti?
...
translate russiantl _call_skipcheck_3_f73d296c:
    ...
    m "Честно говоря, я был настроен немного скептически по отношению к тому, какой кофе они могли бы приготовить в подобном месте. Но после небольшого глотка, должен признать, он не такой уж и плохой. В своей жизни я пробовал кофе гораздо хуже." #TODO?
...
translate russiantl _call_skipcheck_3_141c5d6a:
    ...
    m "По всей видимости, фирменное блюдо состояло из странной на вид рыбы. Я немного колебался, чтобы попробовать её. Но учитывая идущий от неё пар, я решил всё же подождать несколько минут." # TODO
...
translate russiantl _call_skipcheck_3_cac943c3:
    ...
    m "Реза встал из-за стола, прежде чем дать мне понять, что у него осталось несколько незаконченных дел, и покинул ресторан в сопровождении большего из двух драконов." #TODO
...
translate russiantl _call_skipcheck_3_1ccb67dc:
    ...
    m "Теперь не только вся эта ситуация являлась достаточно эксцентричной, но и создавалось чувство опасности, учитывая слова Резы. Я не имел ни малейшего понятия о том, какая угроза могла таиться за всем этим." # TODO
...
translate russiantl _call_skipcheck_3_d54bfe60:
    ...
    m "В конце концов, я снова откусил кусочкек от своего несколько необычного завтрака. В то время как запах казался мне довольно специфическим, на вкус было даже хуже. Блюдо представлялось мне неким видом деликатеса на любителя. На любителя, которым я определённо не являлся. Я решил выйти наружу до того, как станет слишком поздно." #TODO
...
translate russiantl _call_skipcheck_3_1ccb67dc_1:
    ...
    # m "Not that this whole situation was already bizarre enough, there was also now the vague sense of danger conveyed by Reza's earlier words. I did not even have an idea what kind of threat might be lurking out there."
    m "Теперь не только вся эта ситуация являлась достаточно эксцентричной, но и создавалось чувство опасности, учитывая слова Резы. Я не имел ни малейшего понятия о том, какая угроза могла таиться за всем этим." #TODO? я даже не догадывался?
...
translate russiantl _call_skipcheck_3_1ccb67dc_2:
    ...
    # m "Not that this whole situation was already bizarre enough, there was also now the vague sense of danger conveyed by Reza's earlier words. I did not even have an idea what kind of threat might be lurking out there."
    m "Теперь не только вся эта ситуация являлась достаточно эксцентричной, но и создавалось чувство опасности, учитывая слова Резы. Я не имел ни малейшего понятия о том, какая угроза могла таиться за всем этим." #TUUUDOO TODO

# game/chapter1.rpy:1808
translate russiantl _call_skipcheck_3_82a88f03_1:

    # m "Eventually, I got up, ready to be on my way for whatever else the day might bring."
    m "В конце концов, я встал, готовый ко всему, что этот день ещё может принести." # TODO
...
translate russiantl _call_skipcheck_3_2f18e3e6:
    ...
    Sb "И ты будешь не единственным, кто так скажет. Тебе лучше подождать снаружи, так, на всякий случай." #TODO утолстить?
...
translate russiantl _call_syscheck_6_b1ff8271:
    ...
    n "Я вышел на улицу, изучая взглядом пейзажи этого подозрительно знакомого места." #TODO? тавтологию поправить
...
translate russiantl _call_syscheck_6_74fd8cc1:
    ...
    n "Хоть я и провёл тут не так уж и много времени, меня уже восхищали схожести наших миров."

# game/chapter1.rpy:1860
translate russiantl _call_syscheck_6_139655ac:

    # n "After all, we were talking about an unmapped place with a never-before-seen form of life."
    n "В конце концов мы говорили о ранее неизвестном месте населенном доселе невиданной формой жизни." #TODO?

# game/chapter1.rpy:1861
translate russiantl _call_syscheck_6_d563a46a:
    ...
    n "Даже обнаружение простейшего одноклеточного организма или нового вида бактерий было бы значительным открытием."

# game/chapter1.rpy:1862
translate russiantl _call_syscheck_6_8a73ac9b:
    ...
    n "Но вот он я, стоящий посреди деревни построенной расой разумных, говорящих драконов, с обществом, мало чем отличающегося от нашего." #TODO?

# game/chapter1.rpy:1863
translate russiantl _call_syscheck_6_bd21a880:
    ...
    n "Реза, однако, не разделял моего энтузиазма, и был больше поражен генератором, но, учитывая что именно за ним мы и пришли, я не осуждал его за это."

# game/chapter1.rpy:1867
translate russiantl _call_syscheck_6_88cd86e7:
    ...
    nvl clear
    m "Мои размышления были прерваны чем-то слишком близко пронесшимся мимо меня, заставив меня пошатнуться. Это был относительно маленький дракон с пакетом зажатым в его челюсти, который, судя по всему, торопился куда-то."

# game/chapter1.rpy:1879
translate russiantl _call_syscheck_6_394829b3:
...
translate russiantl _call_syscheck_6_5566c4b8:

    # Sb "I gave her a generous tip on your behalf. I hope you don't mind."
    Sb "Я оставил ей щедрые чаевые от твоего лица. Надеюсь ты не против."

# game/chapter1.rpy:1890
translate russiantl _call_syscheck_6_1d4d5f4b:

    # Sb "Don't worry about it."
    Sb "Не переживай." #TODO

# game/chapter1.rpy:1893
translate russiantl _call_syscheck_6_8b6c00cc:

    # Sb "Why's that?"
    Sb "Почему?"

# game/chapter1.rpy:1894
translate russiantl _call_syscheck_6_e9146df2:

    # c "The whole thing where she lost it, because we were humans. How unprofessional. Besides, I don't believe in tipping."
    c "Она вышла из себя потому что мы люди. Какой непрофессионализм. И к тому же, я не даю чаевых." ## TODO?

# game/chapter1.rpy:1895
translate russiantl _call_syscheck_6_09595634:

    # Sb "Well, too late for that now."
    Sb "Ну, уже поздно что-то изменить."

# game/chapter1.rpy:1901
translate russiantl _call_syscheck_6_61dd893b:
    ...
    Sb "В любом случае, так как вы отдали нам КПК и Реза забрал генератор, на сегодня ты свободен. Дай мне знать если тебе куда-то захочеться пойти, или я могу устроить тебе экскурсию по городу." #TODO

# game/chapter1.rpy:1902
translate russiantl _call_syscheck_6_288fbfbf:
    ...
    m "Экскурсия звучала заманчиво, но, помня слова Резы, я хотел быть осторожным и не забредать слишком далеко до того как я узнаю побольше об этом мире." # TODO

# game/chapter1.rpy:1903
translate russiantl _call_syscheck_6_f8b826aa:

    # c "I think I'll stay home for today. I still have to get used to everything, you know?"
    c "Думаю сегодня я останусь дома. Мне еще нужно ко всему привыкнуть, понимаешь?"

# game/chapter1.rpy:1904
translate russiantl _call_syscheck_6_6c1a0363:

    # Sb "I'll just accompany you back, then."
    Sb "Тогда я просто сопровожу тебя домой."

# game/chapter1.rpy:1915
translate russiantl _call_syscheck_6_0a0c2790:

    # Sb "There we are."
    Sb "Мы пришли."

# game/chapter1.rpy:1916
translate russiantl _call_syscheck_6_936e0f77:

    # c "Home, sweet home. For now, at least."
    c "Дом, милый дом. По крайней мере, пока."

# game/chapter1.rpy:1917
translate russiantl _call_syscheck_6_2dd88010:

    # Sb "Well, if you need anything, I'll be outside until my shift ends. Otherwise, I'll see you tomorrow."
    Sb "Если тебе что-нибудь будет нужно, я буду снаружи до конца моей смены. В противном случае, увидимся завтра." #TODO

# game/chapter1.rpy:1918
translate russiantl _call_syscheck_6_f37e170c:

    # c "Thanks, see you tomorrow."
    c "Спасибо, до завтра."

# game/chapter1.rpy:1919
translate russiantl _call_syscheck_6_8a17cbf7:

    # Sb "See ya!"
    Sb "До встречи!"

# game/chapter1.rpy:1931
translate russiantl _call_syscheck_6_76b2fe88:

    # nvl clear
    nvl clear

# game/chapter1.rpy:1935
translate russiantl _call_syscheck_6_221afd4f:
    ...
    n "Мне не выдалось особого случая " #TODO

# game/chapter1.rpy:1936
translate russiantl _call_syscheck_6_bb967794:
    ...
    n "Я обнаружил что кухня была полностью заполнена продуктами, но их разнообразие было потрачено на меня впустую. Я не особо хорошо умел готовить, и, более того, я даже не узнавал некоторые из продуктов"

# game/chapter1.rpy:1937
translate russiantl _call_syscheck_6_f529b0b1:
    ...
    n "Я не был уверен были ли они у нас дома и я просто о них не знал, или они были инопланетными, но я не хотел рисковать и есть неизвестные мне продукты." #TODO

# game/chapter1.rpy:1938
translate russiantl _call_syscheck_6_afd5bd6d:

    # n "After all, it was possible that some of the comestibles might be fine for them to eat, but still be poisonous to us."
    n "Как-никак, некоторые из них могли оказатся пригодны для еды им, но ядовитыми для нас." #TODO?

# game/chapter1.rpy:1939
translate russiantl _call_syscheck_6_05824446:

    # nvl clear
    # n "I was also glad to find a shelf that was filled to the brim with a variety of books."
    nvl clear
    n "Также я с радостью обнаружил полку, забитую до краёв разнообразными книгами."

# game/chapter1.rpy:1941
translate russiantl _call_syscheck_6_27ce47bd:
    ...
    n "Хотя мне и пришлась по вкусу тема книги {i}Человек: Миф или Реальность?{/i}, я был вынужден был завязать с книгой из-за её исключительно сухого стиля письма, которым я не склонен был наслаждаться в данный момент." #TODO

# game/chapter1.rpy:1942
translate russiantl _call_syscheck_6_a13f6eb8:
    ...
    n "В конце концов, я принялся за приключенческий роман про дракониху археолога, которая наткнулась на останки давно потерянной человеческой цивилизации, после чего на неё начинает охотиться злая организация которая хочет использовать найденные артефакты в своих зловещих целях."

# game/chapter1.rpy:1943
translate russiantl _call_syscheck_6_f3eb79d8:
    ...
    n "Хотя он и был довольно занятный, должен признаться что мне он очень слишком напоминал дешевые романы которые были у нас дома. " # TODO тавтология

# game/chapter1.rpy:1944
translate russiantl _call_syscheck_6_1686f415:
    ...
    nvl clear
    n "Я читал (одну) особенно увлекательную сцену в которой главная героиня, Шеридан, использовала один из магических артефактов в форме пары человеческих рук держащих жезл с навершием в виде сферы чтобы движущиеся стены древнего человеческого храма не превратили её в лепешку, когда неожиданно зазвенел дверной звонок." #TODO

# game/chapter1.rpy:1988
translate russiantl _call_syscheck_6_76b2fe88_1:

    # nvl clear
    nvl clear

# game/chapter1.rpy:1995
translate russiantl _call_syscheck_6_b5f20e45:

    # "???" "Hello there! Would you please sign here?"
    "???" "Здравствуйте! Не могли бы ли Вы подписать здесь?"

# game/chapter1.rpy:1997
translate russiantl _call_syscheck_6_46eba8f0:

    # c "I'm not signing away my rights with this, am I?"
    c "Я же не отказываюсь от своих прав подписывая это, так ведь?"

# game/chapter1.rpy:1999
translate russiantl _call_syscheck_6_c83245e4:

    # "???" "I've got a letter for you that requires signature confirmation."
    "???" "У меня есть письмо для Вас, которое требует подтверждения подписи."

# game/chapter1.rpy:2001
translate russiantl _call_syscheck_6_89aefe22:

    # c "I see."
    c "Ясно."

# game/chapter1.rpy:2003
translate russiantl _call_syscheck_6_e01a6f22:
    ...
    m "Посмотрев на блокнот, который маленький дракон держал передо мной, я увидел, что отправителем данного письма был Реза." #TODO?

# game/chapter1.rpy:2007
translate russiantl _call_syscheck_6_39fda16a:

    # c "There you go."
    c "Вот, держите." #TODO?

# game/chapter1.rpy:2009
translate russiantl _call_syscheck_6_00e986e3:

    # Lo normal b flip "I'm Lorem, by the way. Would you mind if I asked you a few questions?"
    Lo normal b flip "Кстати, меня зовут Лорем. Вы не будете против если я задам Вам парочку вопросов?"

# game/chapter1.rpy:2017
translate russiantl _call_syscheck_6_856886b5:

    # Sb "What is this about?"
    Sb "Что здесь происходит?"

# game/chapter1.rpy:2019
translate russiantl _call_syscheck_6_b42e14de:

    # Lo happy b flip "I'm just making small talk."
    Lo happy b flip "Мы просто разговариваем."

# game/chapter1.rpy:2021
translate russiantl _call_syscheck_6_0437a5d3:
    ...
    Sb disapproval b "Постой... я тебя знаю! Ты пытался провернуть подобное и с Резой! Может быть мне следует доложить твоему начальству о твоём неподобающем поведении по отношению к клиентам." #TODO

# game/chapter1.rpy:2023
translate russiantl _call_syscheck_6_c9422976:

    # Lo sad b flip "But it's important! Please, just let me talk to [player_name] for a few minutes!"
    Lo sad b flip "Но это очень важно! Пожалуйста, дайте мне всего-лишь пару минут!" #TODO

# game/chapter1.rpy:2025
translate russiantl _call_syscheck_6_3b272ad6:
    ...
    Sb normal b "Ты же знаешь как это работает. Если ты хочешь получить интервью у человека, тебе придется получить разрешение соответствующих органов."

# game/chapter1.rpy:2027
translate russiantl _call_syscheck_6_a1a7cf43:
    ...
    Lo relieved b flip "Помоги мне, [player_name]. Тебе же, как представителю человечества, важно чтобы в СМИ описали людей как можно точнее, не так ли?" ## TODO:

# game/chapter1.rpy:2029
translate russiantl _call_syscheck_6_27ab87a8:
    ...
    Lo happy b flip "Тогда тебе нужно поговорить со мной. В противном случае, кто-то еще заполнит пробелы и кто знает, что они придумают."

# game/chapter1.rpy:2031
translate russiantl _call_syscheck_6_d1179078:

    # Lo normal b flip "Let me show you something."
    Lo normal b flip "Позволь мне показать тебе кое-что."

# game/chapter1.rpy:2035
translate russiantl _call_syscheck_6_aa49c3cb:

    # m "The small dragon opened his bag, rummaging through a number of letters and small packages."
    m "Маленький дракон открыл свою сумку с кучей писем и посылок и начал копатся в ней."

# game/chapter1.rpy:2037
translate russiantl _call_syscheck_6_53d64cd9:

    # Lo think b flip "Huh, I think I lost it."
    Lo think b flip "Блин, наверное потерял."

# game/chapter1.rpy:2039
translate russiantl _call_syscheck_6_76f36185:
    ...
    Lo happy b flip "Я хотел показать показать тебе изобр" # TODO

# game/chapter1.rpy:2041
translate russiantl _call_syscheck_6_0ce0d2c1:

    # c "What are you, Lorem? A reporter?"
    c "Кто ты, Лорем? Журналист?"

# game/chapter1.rpy:2043
translate russiantl _call_syscheck_6_b27aa55e:

    # Lo normal b flip "No, I'm just..."
    Lo normal b flip "Нет, я просто..."

# game/chapter1.rpy:2045
translate russiantl _call_syscheck_6_5c0efd1f:

    # Sb normal b "Do you want me to remove him, [player_name]?"
    Sb normal b "Хочешь чтобы я его вывел, [player_name]?" #TODO

# game/chapter1.rpy:2047
translate russiantl _call_syscheck_6_f7b4cd7f:

    # c "Is what he is saying true?"
    c "Он говорит правду?"

# game/chapter1.rpy:2049
translate russiantl _call_syscheck_6_9d8dad31:

    # Sb drop b "Yeah, I guess..."
    Sb drop b "Ну да..."

# game/chapter1.rpy:2051
translate russiantl _call_syscheck_6_ffdd2402:

    # c "I see. That sounds pretty interesting, though."
    c "Понятно. Но, это довольно заманчивое предложение. " #TODO

# game/chapter1.rpy:2053
translate russiantl _call_syscheck_6_fbc14d2f:

    # c "Alright, you can leave your number here and maybe I'll call you later, but that's all I can promise."
    c "Ладно, можешь оставить мне свой номер и возможно я тебе позвоню позже, но ничего не обещаю."

# game/chapter1.rpy:2055
translate russiantl _call_syscheck_6_4a00b3f9:

    # Lo happy b flip "Thank you! Thank you so much!"
    Lo happy b flip "Спасибо! Спасибо огромное!"

# game/chapter1.rpy:2059
translate russiantl _call_syscheck_6_d047da4e:
    ...
    m "Он быстро достал листик, написал свой номер на нём, и застенчиво протянул его мне обоими руками."

# game/chapter1.rpy:2061
translate russiantl _call_syscheck_6_786007d9:

    # Sb disapproval b "Alright, you got what you wanted. Off you go, now."
    Sb disapproval b "Ладно, ты получил то что хотел, теперь иди."

# game/chapter1.rpy:2077
translate russiantl _call_syscheck_6_9e99e262:

    # Lo "Eeeeeeeeeeeee~!"
    Lo "Иииииииии~" #TODO

# game/chapter1.rpy:2079
translate russiantl _call_syscheck_6_2997ffea:

    # Sb normal b "Sorry about that."
    Sb normal b "Прошу меня простить." #TODO

# game/chapter1.rpy:2081
translate russiantl _call_syscheck_6_5101fbef:

    # c "Don't worry about it."
    c "Не переживай об этом." #TODO не бери в голову?

# game/chapter1.rpy:2083
translate russiantl _call_syscheck_6_66a3f50e:

    # Sb "I guess that should be all. I'll see you tomorrow, then."
    Sb "Я думаю на сегодня все. Увидимся завтра."

# game/chapter1.rpy:2085
translate russiantl _call_syscheck_6_f5f7c27d:

    # c "Right."
    c "Ага."

# game/chapter1.rpy:2095
translate russiantl _call_syscheck_6_6083d3f2:

    # m "With all the commotion, I almost forgot that I was also still holding Reza's letter."
    m "Из-за всей этой суматохи, я почти забыл что у меня в руках было письмо Резы."

# game/chapter1.rpy:2101
translate russiantl _call_syscheck_6_f84a7975:

    # n "Within the plain envelope was a similarly plain sheet of paper with his handwriting."
    n "Внутри простого конверта был такой же простой лист бумаги исписанный его почерком."

# game/chapter1.rpy:2102
translate russiantl _call_syscheck_6_130a299e:
    ...
    n "Но когда я начал его читать, я увидел что его фразы были настолько полны любезностей которые он ненавидел, что я предположил, что каждое его слово было подделано, чтобы скрыть его истинное значение." # TODO

# game/chapter1.rpy:2103
translate russiantl _call_syscheck_6_5dc3c29d:

    # n "He did mention I'd know what to do, but I was unsure of how I was supposed to decode the letter's secret message."
    n "Но он упомянул что я буду знать что делать, но я даже и не предполагал как разшифровать его секретное послание." #TODO

# game/chapter1.rpy:2104
translate russiantl _call_syscheck_6_1a7f73a9:
    ...
    n "Я не припоминал, чтобы когда-нибудь разговаривал с ним на эту тему, но он все-же был уверен что я пойму что делать, или он подумал что я сам догадаюсь" # TODO

# game/chapter1.rpy:2105
translate russiantl _call_syscheck_6_d55f237b:

    # n "This is what it said:"
    n "Вот что в нём было написано:"

# game/chapter1.rpy:2106
translate russiantl _call_syscheck_6_a6f97c4f:

    # nvl clear
    # n "Hello, my dear friend."
    nvl clear
    n "Привет, мой дорогой друг."

# game/chapter1.rpy:2108
translate russiantl _call_syscheck_6_3a473542:

    # n "I hope this letter reached you swiftly and in good condition."
    n "Я надеюсь что это письмо дошло до тебя быстро и в хорошем состоянии." #TODO

# game/chapter1.rpy:2109
translate russiantl _call_syscheck_6_5e27acbf:
    ...
    n "К сожалению, мы не успели поговорить о многих вещах, и поэтому я решил написать тебе это письмо. Как у тебя дела?. Чем ты занимался? Как поживает твоя семья?" # TODO

# game/chapter1.rpy:2110
translate russiantl _call_syscheck_6_3ab950eb:
    ...
    n "Нам так о многом нужно поговорить. Хотя-бы мы можем это сделать в письменной форме." #TODO

# game/chapter1.rpy:2111
translate russiantl _call_syscheck_6_aa5d79bd:

    # n "Quite an exciting venture we are on now, right? How have you liked it here so far? Made any dragon friends yet?"
    n "Довольно захватывающая авантюра у нас, не так ли? Тебе здесь понравилось? Уже завел себе друзей среди драконов?"

# game/chapter1.rpy:2112
translate russiantl _call_syscheck_6_b6d60ff7:

    # n "Haha."
    n "Хаха."

# game/chapter1.rpy:2113
translate russiantl _call_syscheck_6_d29ad334:

    # n "Anyways, I will be looking forward to your reply soon."
    n "В любом случае, буду с нетерпением ждать твоего ответа."

# game/chapter1.rpy:2114
translate russiantl _call_syscheck_6_49f83c7e:

    # n "Best regards,"
    n "С наилучшими пожеланиями,"

# game/chapter1.rpy:2115
translate russiantl _call_syscheck_6_fa43a229:

    # n "Reza"
    n "Реза"

# game/chapter1.rpy:2118
translate russiantl _call_syscheck_6_eb96567d:
...
translate russiantl menu1_5e77f51a:

    # m "After looking at it for a while, I came to the conclusion that the secret message said that Reza wanted me to:"
    m "После небольших раздумий я пришел к выводу что Реза хотел от меня:"

# game/chapter1.rpy:2168
translate russiantl _call_increasing_3_76b2fe88:

    # nvl clear
    nvl clear

# game/chapter1.rpy:2174
translate russiantl _call_increasing_3_c47bce3b:

    # n "Hello, my dear friend."
    n "Привет, мой дорогой друг."

# game/chapter1.rpy:2175
translate russiantl _call_increasing_3_3a473542:

    # n "I hope this letter reached you swiftly and in good condition."
    n "Я надеюсь что это письмо дошло до тебя быстро и в хорошем состоянии."

# game/chapter1.rpy:2176
translate russiantl _call_increasing_3_5e27acbf:

    # n "Unfortunately, we were not able to catch up earlier, so I wanted to write you this letter. How have you been these last few years? What have you been doing? How's the family?"
    n "К сожалению, мы не успели поговорить о многих вещах, и поэтому я решил написать тебе это письмо. Как у тебя дела?. Чем ты занимался? Как поживает твоя семья?"

# game/chapter1.rpy:2177
translate russiantl _call_increasing_3_3ab950eb:

    # n "I feel like there is so much we should talk about, since we have not seen each other much recently. At least we have a chance to do so in this form."
    n "Нам так о многом нужно поговорить. Хотя-бы мы можем это сделать в письменной форме."

# game/chapter1.rpy:2178
translate russiantl _call_increasing_3_aa5d79bd:

    # n "Quite an exciting venture we are on now, right? How have you liked it here so far? Made any dragon friends yet?"
    n "Довольно захватывающая авантюра у нас, не так ли? Тебе здесь понравилось? Уже завел себе друзей среди драконов?"

# game/chapter1.rpy:2179
translate russiantl _call_increasing_3_b6d60ff7:

    # n "Haha."
    n "Хаха."

# game/chapter1.rpy:2180
translate russiantl _call_increasing_3_d29ad334:

    # n "Anyways, I will be looking forward to your reply soon."
    n "В любом случае, буду с нетерпением ждать твоего ответа."

# game/chapter1.rpy:2181
translate russiantl _call_increasing_3_49f83c7e:

    # n "Best regards,"
    n "С наилучшими пожеланиями,"

# game/chapter1.rpy:2182
translate russiantl _call_increasing_3_fa43a229:

    # n "Reza"
    n "Реза"

# game/chapter1.rpy:2185
translate russiantl _call_increasing_3_76b2fe88_1:

    # nvl clear
    nvl clear

# game/chapter1.rpy:2193
translate russiantl _call_increasing_3_49cddd54:
    ...
    m "Строки, ну конечно же. Может быть мне нужно было прочитать между них? У меня не было с собой приспособления что-бы прочитать мелкий текст, хотя я сомневался что Реза смог бы что-то им написать." #TODO
...
translate russiantl _call_syscheck_7_1d124486:
    ...
    n "Я едва достигнул возраста, в котором от меня ожидалось найти супругу и остепениться, но никто из моих сверстников не интересовал меня в этом плане. Они все были прям как дети, грубыми и некультурными."

# game/chapter1.rpy:2350
translate russiantl _call_syscheck_7_133cdd03:
    ...
    n "Я был потерян в море неуверенности, и дрейфовал, надеясь однажды быть найденным моей второй половинкой. И, однажды это случилось. Как быстро летит время, когда ты счастлив, я не могу поверить, что это было всего две недели назад. Две недели назад я нашел одну, самую настоящую родственную душу из всех, что только могли быть."

# game/chapter1.rpy:2351
translate russiantl _call_syscheck_7_a455b8f2:
    ...
    n "Как таран, он вышел из ниоткуда, сломал все барьеры и вошел в мою жизнь. Две недели назад я был никем. Сегодня я самый счастливый дракон из живых. Кто же знал что чтобы исправить мою жизнь,из всех живущих драконов, понадобится только один."

# game/chapter1.rpy:2352
translate russiantl _call_syscheck_7_43576349:

    # n "Who knew that to meet the perfect one, the only thing you needed was..."
    n "Кто бы мог подумать, что для того, чтобы встретить ту самую, вам нужно всего лишь..."

# game/chapter1.rpy:2355
translate russiantl _call_syscheck_7_d58440a5:

    # c "(I don't think there's anything in here.)"
    c "(Я не думаю что тут что-то есть.)" #TODO

# game/chapter1.rpy:2356
translate russiantl _call_syscheck_7_1271fbc7:

    # c "(And who let this mess ever get to print? Sheesh.)"
    c "(Вот блин, кто вообще пустил эту фигню в печать?)"
...
translate russiantl _call_syscheck_7_c955ae7b:

    # n "Arc 1"
    n ""

# game/chapter1.rpy:2368
translate russiantl _call_syscheck_7_5bf94afa:
...
translate russiantl _call_syscheck_7_821d6d0f:
...
translate russiantl _call_syscheck_7_086c75fa:
...
translate russiantl _call_syscheck_7_cb0d94b1:
...
translate russiantl _call_syscheck_7_8232aab7:
...
translate russiantl _call_syscheck_7_8375a702:
...
translate russiantl _call_syscheck_7_8bbad953:

    # n "Chapter 1: Rise from the Ashes"
    n ""

# game/chapter1.rpy:2390
translate russiantl _call_syscheck_7_656baca5:
...
translate russiantl _call_syscheck_7_73caa4fd:
...
translate russiantl _call_syscheck_7_bc88c2a7:
...
translate russiantl _call_syscheck_7_cee76091:

    # n "Preface"
    n ""

# game/chapter1.rpy:2411
translate russiantl _call_syscheck_7_307485c8:
...
translate russiantl _call_syscheck_7_f856dbde:
...
translate russiantl _call_syscheck_7_5c77d342:
...
translate russiantl _call_syscheck_7_dd0a95c7:
...
translate russiantl _call_syscheck_7_a3139658:

    # n "Quick start guide:"
    n ""

# game/chapter1.rpy:2432
translate russiantl _call_syscheck_7_b1a5acb1:

    # n "Step 1."
    n ""

# game/chapter1.rpy:2433
translate russiantl _call_syscheck_7_5edbf34a:
...
translate russiantl _call_syscheck_7_a21e46b1:
...
translate russiantl _call_syscheck_7_9f288208:
...
translate russiantl _call_syscheck_7_5f96bbb0:

    # n "Plug your Ixomen Sphere into any fitting household outlet."
    n ""

# game/chapter1.rpy:2438
translate russiantl _call_syscheck_7_b6ffd358:
...
translate russiantl _call_syscheck_7_198c2afb:

    # n "Step 3."
    n ""

# game/chapter1.rpy:2440
translate russiantl _call_syscheck_7_993c561f:

    # n "Locate the power switch of the Ixomen Sphere."
    n ""

# game/chapter1.rpy:2441
translate russiantl _call_syscheck_7_cf187513:
...
translate russiantl _call_syscheck_7_4f1f0b5f:
    ...
    c "(Может быть Реза оставил мне здесь еще одно сообщение. Он мог знать что я буду жить в этом доме, и возможно он спятал тут что-нибудь.)" #TODO

# game/chapter1.rpy:2466
translate russiantl _call_syscheck_7_d0a1ba27:
    ...
    c "(Но нет, даже после того как я убрал все книги с полки, я не нашел на полке что-то, чтобы помогло мне разшифровать это сообщение.)" #TODO

# game/chapter1.rpy:2468
translate russiantl _call_syscheck_7_454d542b:

    # c "(But even if Reza did leave a hint, this could've been anywhere in the apartment, and not just on this bookshelf.)"
    c "(Но, если Реза оставил тут подсказку, она могла быть везде, а не только на этой книжной полке.)" #TODO
...
translate russiantl medmenu_ff003015:
    ...
    c "(Не уверен что это хорошая затея, но погнали.)"
...
translate russiantl medmenu_48a7af66:
    ...
    c "(Ну, еще одна не навредит.)"

# game/chapter1.rpy:2508
translate russiantl medmenu_1833821b:

    # c "(Can't hurt... because they're pain meds. Hehe.)"
    c "(Надеюсь мне не будет больно... потому что это болеутоляющие. Хехе.)" # TODO? отсылка на 451 градусов по фаренгейту
...
translate russiantl medmenu_784f0a27:
    ...
    c "(Сколько времени я провел в отключке? И почему я подумал что наглотавшись таблеток я каким-то образом найду как разшифровать письмо?)" #TODO?
...
translate russiantl _call_syscheck_8_639a756b:
    ...
    s "Вы наглотались таблеток. Это была плохая идея."
...
translate russiantl _call_syscheck_8_bd37d40e:
    ...
    s "Ты наглотался таблеток. Наверное следовало бы догадаться что это была плохая идея."
...
translate russiantl menufridge_1ac24b1a:
    ...
    c "(Это просто кусок мяса. Ничего необычного.)"
...
translate russiantl menufridge_6172e154:
    ...
    c "(Да, я только что потратил впустую кучу яиц.)"

# game/chapter1.rpy:2624
translate russiantl _call_syscheck_9_3c30cbb7:

    # s "You just wasted a perfectly good batch of eggs!"
    s "Вы только что потратили впустую кучу яиц!"

# game/chapter1.rpy:2628
translate russiantl _call_syscheck_9_c61717bb:

    # s "You just wasted a perfectly good batch of eggs. Poor eggs."
    s "Ты только что потратили впустую кучу яиц. Бедные яички."

# game/chapter1.rpy:2632
translate russiantl _call_syscheck_9_5ffd7263:

    # s "You just wasted a perfectly good batch of eggs. I hope you're happy now."
    s "Ты только что потратили впустую кучу яиц. Надеюсь ты доволен собой."

# game/chapter1.rpy:2639
translate russiantl _call_syscheck_9_4e61119b:

    # c "(It's an unlabeled container with some sort of white liquid inside. Well, here goes nothing.)"
    c "Это неподписанный контейнер с какой-то белой жидкостью. Ну, была не была."

# game/chapter1.rpy:2642
translate russiantl _call_syscheck_9_fe477319:

    # c "(It's salty.)"
    c "(На вкус она соляноватая.)" #TODO? солоноватый?

# game/chapter1.rpy:2662
translate russiantl _call_syscheck_10_225eef0f:

    # s "You drank a mystery liquid!"
    s "Вы выпили неизвестную жидкость!"

# game/chapter1.rpy:2666
translate russiantl _call_syscheck_10_ead2e792:

    # s "You drank a mystery liquid. Good for you."
    s "Ты выпил неизвестную жидкость. Молодец."

# game/chapter1.rpy:2670
translate russiantl _call_syscheck_10_6d8b299c:

    # s "You drank a mystery liquid. I'm proud of you."
    s "Ты выпил неизвестную жидкость. Я тобой горжусь."

# game/chapter1.rpy:2680
translate russiantl _call_syscheck_10_ee60a578:

    # c "(Just some fruits and veggies here.)"
    c "(Тут лежит немного фруктов и овощей.)"

# game/chapter1.rpy:2707
translate russiantl _call_syscheck_11_09be8c4f:

    # s "You learned a lot about fruits!"
    s "Вы узнали много интересного о фруктах!"

# game/chapter1.rpy:2711
translate russiantl _call_syscheck_11_763e13c5:

    # s "You learned a lot about fruits. Kinda."
    s "Ты узнал много интересного о фруктах. Наверное."

# game/chapter1.rpy:2715
translate russiantl _call_syscheck_11_488ed202:

    # s "You learned a lot about fruits. Could've added a few more puns, though."
    s "Ты узнал много интересного о фруктах. Хотя, ещё парочка каламбуров не помешала бы."

# game/chapter1.rpy:2722
translate russiantl _call_syscheck_11_7b6290e9:

    # c "(What should I look at?)" nointeract
    c "(На что мне посмотреть?)" nointeract #TODO
...
translate russiantl _call_syscheck_11_a2f6be37:
    ...
    c "(Что я знаю про фиги? Довольно много, на самом деле. Фиги имеют большую культурную ценность в религиозных кругах, и богаты историей.)" #TODO

# game/chapter1.rpy:2736
translate russiantl _call_syscheck_11_7f70b567:
    ...
    c "(Например, в библии, Адам и Ева прикрывали срамные места именно листьями фигового дерева. Также именно под ним Будда достиг просветления.)"

# game/chapter1.rpy:2737
translate russiantl _call_syscheck_11_c3a06d2e:

    # c "(Not only that, but it is also mentioned in Greek mythology. Isn't it fascinating?)"
    c "(Они даже упоминаются в греческой мифилогии. Увлекательно, не правда ли?)"

# game/chapter1.rpy:2738
translate russiantl _call_syscheck_11_1e35e980:

    # c "(But wait, there's more: The influence of figs also extends towards words, phrases and sayings we still use today.)"
    c "(Но постойте, это еще не всё: фиги также повлияли на некоторые слова, фразы и поговорки которые используются по сей день.)"

# game/chapter1.rpy:2739
translate russiantl _call_syscheck_11_b897d68b:
    ...
    c "(Например слово \"подхалим\" происходит от греческого выражения которое означает, \"кто-то показывающий фигу\". В те времена это считалось неприличным жестом. Или можно взять выражение \"Мне по-фиг\", которое является фиг-урой речи.)" #TODO?

# game/chapter1.rpy:2740
translate russiantl _call_syscheck_11_acb439a1:
    ...
    c "Можно даже сказать что влияние фиг настолько велико, наскольно они сами сладки. Фиг-урно выражаясь." #TODO образно

# game/chapter1.rpy:2741
translate russiantl _call_syscheck_11_9ca3ba4e:

    # c "(I'm afraid nothing of this actually helps with Reza's letter, though.)"
    c "(Но я не думаю что это всё как-то поможет разшифровать письмо Резы.)"

# game/chapter1.rpy:2747
translate russiantl _call_syscheck_11_4c8f346f:

    # c "(There are two of them. What a nice pear.)"
    c "(Тут их две. Какие прекрасные груши.)" #TODO

# game/chapter1.rpy:2753
translate russiantl _call_syscheck_11_9c2c9e41:
    ...
    c "(Заходят как-то в бар две виноградины, и бармен их спраши... Ладно, согласен, плохая шутка.)"
...
translate russiantl _call_syscheck_11_6d1e2555:
    ...
    m "После этого я продолжил читать книгу про приключения Шеридан и её успехи в уничтожении предметов материальной культуры."
...
translate russiantl _call_syscheck_11_d7a61edb:
    ...
    m "Как и ожидалось, наступил счастливый конец, планам злой организации не суждено было сбыться, и весь мир смог снова вздохнуть спокойно, по крайней мере сейчас. Я думал что концовка была преднамеренно оставлена неопределенной, но когда я перевернул страницу и увидел рекламу следующей части в этой серии книг, я понял что вся эта книга — одна большая подготовка к неизбежному сиквелу."
...
translate russiantl continuation_0b0eb11f:
    ...
    m "Пока я шёл я задавался вопросом не идет ли кто-то за мной, но вокруг никого не было. Неужели все уже спали?" #TODOoooo
...
translate russiantl continuation_7d4645bd:
    ...
    Rz "Скоро этого места не станет, и нам нужно убраться до того как это случится." # TODO?

# game/chapter1.rpy:2843
translate russiantl continuation_cc4c03c2:

    # Rz "You do? Well, then you know what we've got to do, right?"
    Rz "Правда? Ну, тогда ты знаешь что нам нужно делать, ведь так?"
...
translate russiantl continuation_f763377c:
    ...
    Rz "Я надеялся что ты тоже все поймешь, но с другой стороны мне понадобилось немало времени, и я тут нахожусь больше чем ты. В любом случае..." #TODO

# game/chapter1.rpy:2852
translate russiantl continuation_f763377c_1:

    # Rz "I hoped you'd see it too, but then it took me a while to understand, and I had a head start on you. In any case..."
    Rz "Я надеялся что ты тоже все поймешь, но с другой стороны мне понадобилось немало времени, и я тут нахожусь больше чем ты. В любом случае..."
...
translate russiantl continuation_fd1f97a7:
    ...
    m "Пока он говорил, мой взгляд блуждал и остановился на каком-то движении поблизости. Трудно было что-то разглядеть, и я предположил, что это просто ветер в кустах. Но на дворе стояла безветреная погода." #TODO
...
translate russiantl continuation_2ffb6474:
    ...
    m "Движение подошло к нам поближе, и вскоре стало ясно что это был Маверик, спрятавшийся чтобы подслушать наш разговор." #TODOOOOO
...
translate russiantl continuation_4f9d14fc:
    ...
    m "В боку дракона четко виднелась рана от пули, и струйка крови стекала на землю, окрашивая его чешую в бордовый цвет. Реза воспользовался случаем чтобы сбежать куда-то, но я не увидел куда именно." #TODO?

# game/chapter1.rpy:2908
translate russiantl continuation_b002be4f:
    ...
    m "Я судорожно осмотрелся, пытаясь найти взглядом Резу, но он уже исчез в темноте. Что мне было делать? Тоже убежать? Помочь Маверику? Я был обычным дипломатом и не имел не малейшего понятия о том что происходило." #TODO

# game/chapter1.rpy:2918
translate russiantl continuation_a868f086:
    ...
    m "Неожиданно, дракон резко развернулся, ударив меня в живот своим хвостом. Я ненадолго оторвался от земли, прежде чем почувствовал, как мое тело ударилось о землю настолько сильно, что мое зрение почти сразу затуманилось." #TODO

# game/chapter1.rpy:2922
translate russiantl continuation_c3aa840b:
    ...
    m "Оглушительный рёв. Был ли это его крик о помощи? Я ели-ели мог двигаться, но мне показалось что лучше оставаться на месте, чтобы не давать раненому дракону повод. Он мог бы с легкостью меня прикончить, если бы захотел." #TODO

# game/chapter1.rpy:2926
translate russiantl continuation_511c581f:

    # m "I heard him take a few unsure steps before he lay down on the ground, panting."
    m "Я слышал как он, сделав пару неуверенных шагов, лег на землю, тяжело дыша." #TODO

# game/chapter1.rpy:2930
translate russiantl continuation_a78188f5:
...
translate russiantl continuation_8763d15f:
...
translate russiantl continuation_f5a82162:

    # m "I heard Sebastian and Maverick exchange a few words, when the stocky fellow approached me."
    m "Я слышал как Себастиан и Маверик обменялись парой слов, а коренастый товарищ подошел ко мне" #TODO
...
translate russiantl continuation_a8f3d766:
    ...
    Br "Я Брюс, шеф полиции в этом городе. Можешь рассказать мне что произошло?"
...
translate russiantl continuation_fb6d338d:
    ...
    m "Он задумался со строгим выражением лица, и я услышал разговор Себастиана."  #TODO
...
translate russiantl continuation_356de34c:
    ...
    m "Я знал что мои переживания все равно ничего бы не изменили, и я начал читать еще одну книгу."
...
translate russiantl continuation_e6336435:
    ...
    m "Неужели Брайс, сам шеф полиции, будет сегодня меня сопровождать?"
...
translate russiantl continuation_8c191191:
    ...
    m "В этот раз, меня повели другой дорогой нежели вчера. И я был уверен что это не просто обычная прогулка."

# game/chapter1.rpy:3046
translate russiantl continuation_b044f66d:

    # c "I'll just go ahead and guess you didn't find Reza."
    c "Смею предпожожить что вы так и не нашли Резу."
...
translate russiantl continuation_61783f37:
    ...
    c "Понятие не имею с чего бы Реза мог пойти на такое. Я понимаю конечно что они друг друга недолюбливали, но чтобы настолько... Кстати, как он?"
...
translate russiantl continuation_a0b6f7f7:
    ...
    Br "Маверик в полном порядке, но я даже не знаю кого во всём этом винить. Ты прав, они действительно друг друга недолюбливали."
...
translate russiantl continuation_7a99e663:
    ...
    Br "В его показаниях Маверик подозревает что Реза планирует какое-то нападение. Ничего об этом не знаешь?"
...
translate russiantl continuation_ebde17ff:
    ...
    c "Нет, он только сказал мне что кое-что должно было произойти, но он ничего не говорил о своих планах. Ну, по крайней мере мне так кажется."
...
translate russiantl continuation_36b1d91b:
    ...
    c "Это просто абсурд. Зачем нам после выполнения своей части сделки, ставить всё под угрозу подобными действиями?"
...
translate russiantl continuation_b1d6e9a7:
    ...
    c "У вас даже уже есть наши КПК, а взамен мы пока ничего не получили. Если бы даже у нас и были какие-то коварные планы, сейчас не самое лучшее время для их исполнения."
...
translate russiantl continuation_331ab8bc:
    ...
    Br "Тут ты прав. Я тебе верю, и у нас, в принципе, нет никаких доказательств твоей вины в этом деле, кроме слов Маверика. Он все-таки провел больше времени с Резой чем любой из нас."
...
translate russiantl continuation_3e2508cf:
    ...
    Br "Но даже не смотря на это, у него не было никаких причин следовать за вами вчера, и он не имел права себя так вести. Я рад что ты в порядке."
...
translate russiantl continuation_7e4b50e4:
    ...
    Br "Если бы он не был на больничном, его бы уже давно задержали. Нам придеться подождать пока эта ситуация не утихнет до того, как мы решим что с ним делать, но я могу тебя заверить что он легко не отделается."
...
translate russiantl continuation_948ed879:
    ...
    Br "Я лично тебе это гарантирую."

# game/chapter1.rpy:3088
translate russiantl continuation_dd21be7f_2:

    # c "We still got quite a lot on our hands now, though. We have a wounded dragon and a missing human. This could lead to a diplomatic crisis."
    c "Но сейчас у нас очень много работы. У нас на руках раненый дракон и пропавший человек, это может привести к дипломатическому кризису."
...
translate russiantl continuation_e3c5319a:
    ...
    Br "Может быть Реза обьявится и мы сможем оставить всё это позади."
...
translate russiantl continuation_63eccaf9:
    ...
    c "Я очень на это надеюсь. Не хотелось бы портить наши отношения из-за этого происшествия."
...
translate russiantl continuation_ae7588ea:
    ...
    n "В конце концов мы прибыли в полицейский участок, и шеф принял у меня показания о вчерашних событиях."
...
translate russiantl continuation_a3c25806:
    ...
    n "Также он спросил у меня о Резе и Маверике. Не то чтобы я, конечно, знал о том что между ними происходило, или что это была за катастрофа о которой упомянул Реза."
...
translate russiantl continuation_39b1be3e:
    ...
    n "После этого он поблагодарил меня, и ушел оформлять мои показания, в то время как я сидел за его столом в ожидании, и вслушивался в происходящее в этом маленьком, привинциальном полицейском участке."
...
translate russiantl continuation_53bd0501:
    ...
    n "Когда он вернулся, к нему подошел кто-то, судя по всему, с важными новостями. Они много разговаривали между собой, но я не мог ничего услышать со своего места. Это продолжалось до тех пор пока Брайс ко мне не подошел."
...
translate russiantl continuation_9f601431:
    ...
    Br "Боюсь, что у нас есть еще плохие новости для тебя. Реза теперь официально подозревается в убийстве."
...
translate russiantl continuation_72321397:
    ...
    Br "Мы направляемся на место преступления и надеялись что ты пойдешь с нами."
...
translate russiantl continuation_2f8adaed:
    ...
    c "Я? На место приступления? Я же даже не разбираюсь в криминалистике."
...
translate russiantl continuation_6e5c7142:
    ...
    Br "Просто ты единственная наша зацепка по делу Резы. Подумай о том что он упомянал насчет того что с нами произойдёт. В наших же интересах найти его как можно скорее и если он в этом замешан, возможно ты сможешь нам помочь найти его."
...
translate russiantl continuation_e8f43124:
    ...
    Br "Твоё сотрудничество определенно было бы воспринято как большой жест доброй воли который бы показал тем кто о тебе не лучшего мнения после вчерашних событий что тебе можно доверять."

# game/chapter1.rpy:3144
translate russiantl _call_syscheck_12_9f70b105:

    # s "You refused to help Bryce for the 99th time!"
    s "Вы отказались помочь Брюсу 99 раз."

# game/chapter1.rpy:3148
translate russiantl _call_syscheck_12_eba32f61:

    # s "You refused to help Bryce for the 99th time. Woohoo!"
    s "Ты отказался помочь Брюсу 99 раз. Ура!"

# game/chapter1.rpy:3152
translate russiantl _call_syscheck_12_9ff20410:

    # s "You refused to help Bryce for the 99th time. You need more hobbies."
    s "Ты отказался помочь Брюсу 99 раз. Тебе что, нечем больше заняться?"

# game/chapter1.rpy:3154
translate russiantl _call_syscheck_12_b11d330a:

    # Br "Will you help us?" nointeract
    Br "Ты поможешь нам?" nointeract

# game/chapter1.rpy:3161
translate russiantl _call_syscheck_12_bf72188d:
    ...
    Br "Я настоятельно прошу тебя изменить своё решение!" #TODO

# game/chapter1.rpy:3170
translate russiantl _call_syscheck_12_f1ed3266:

    # Br "I suppose I'll just have to keep asking you until you change your mind."
    Br "Полагаю, мне просто придется продолжать спрашивать тебя, пока ты не передумаешь." #TODO?

# game/chapter1.rpy:3176
translate russiantl _call_syscheck_12_23b9c64c:
    ...
    c "Я полагаю, у меня нет особого выбора, но ты прав. Нам нужно найти Резу, и если это то что от меня требуется, я готов." #TODO я готов на все тип

# game/chapter1.rpy:3178
translate russiantl _call_syscheck_12_a0ed9bc5:

    # Br "Very well. Let us go, then."
    Br "Очень хорошо. Ну тогда пошли." #TODO
...
translate russiantl investigation_3d599416:
    ...
    m "Пока мы шли, он пытался меня морально подготовить к тому, с чем мы столкнемся. Так как я учил биологию, мне уже приходилось видеть мертвых животных. Я задумался будут ли эти вещи похожи друг на друга, и как бы я отреагировал если бы это был не дракон, а человек."
...
translate russiantl investigation_f17df21d:
    ...
    Sb "Этим утром, жертва была найдена летуном-доставщиком из одного ресторана. Причиной смерти скорее всего являлась потеря крови от множественных ран. Криминалисты уже тут побывали, так что можете свободно тут копаться."

# game/chapter1.rpy:3201
translate russiantl investigation_41043505:
    ...
    m "В нескольких шагах от нас, жертва лежала на земле под простыней, которая закрывала тело, но не огромное кровавое пятно под ним. Мы подошли, а Себастиан тем временем пошел отгонять любопытных зевак."
...
translate russiantl investigation_331499d0:
    ...
    # Br "Yeah, RIP." reference to Deus Ex: Mankind Divided.
    Br "Ага, земля ему пухом."

# game/chapter1.rpy:3227
translate russiantl investigation_d0ff8c97:

    # Br "Let's just say this will be your test, and tell me what you can deduce from what you see. Give it your best shot."
    Br "Давай так: это будет твоя проверка, осмотри тут все и скажи мне свои выводы. Покажи всё на что ты способен."
...
translate russiantl investigation_f03b7e71:
    ...
    m "Два крыла, две ноги, прямо как у той официантки из кафе. По росту он даже был почти похож на человека, разве что чуть-чуть выше. Но размах его крыльев должно быть был впечатляющим."
...
translate russiantl quest1_b280f335:
    ...
    c "Углы, под которыми были нанесены удары выглядят странно. Возможно что они были нанесены кем-то намного больше или намного меньше его." #TODO

# game/chapter1.rpy:3302
translate russiantl quest1_15db375d:

    # Br "No, I don't think that's it."
    Br "Не, не думаю что это так." #TODO?

# game/chapter1.rpy:3308
translate russiantl quest1_741562dc:

    # Br "How so? That seems pretty unlikely."
    Br "Как это? Это кажется маловероятным." #TODO
...
translate russiantl quest1_fdc342bb:
    ...
    c "Они выглядят так, как будто их нанесли ножом или другим острым приспособлением."
...
translate russiantl quest2_cc15fd9a:
    ...
    Br "Вообще-то используют. В основном те у которых есть подходящие руки, но все же..." #TODO
...
translate russiantl quest2_e2599129:
    ...
    Br "Какое страное приспособление."
...
translate russiantl quest2_5df50500:
    ...
    Br "Ну, у него могла быть причина использовать нож вместо этого \"пистолета\". Как думаешь, какая?"
...
translate russiantl quest2_7d1411e6:
    ...
    Br "Это да. Только те из нас которые ходят на двух ногах могут ловко управляться с ножом. Другие драконы скорее всего бы просто кусали."

# game/chapter1.rpy:3349
translate russiantl quest2_293a28a6:

    # Br "Of course, this rules out most of the bigger dragons, and flyers."
    Br "Но, это исключает большую часть крупных драконов и летунов из списка подозреваемых."

# game/chapter1.rpy:3350
translate russiantl quest2_17a65951:

    # Br "But then, Reza still has his... what was it called again?"
    Br "Но у Резы же всё еще есть его вот этот... как эта штука называется?"

# game/chapter1.rpy:3351
translate russiantl quest2_7a5556cf:

    # c "You mean his gun?"
    c "Ты имеешь ввиду его пистолет?"

# game/chapter1.rpy:3352
translate russiantl quest2_42490ba7:

    # Br "Yeah. If it was him, why would he kill someone with a knife rather than just use this \"gun\" on him?"
    Br "Ага. Если это был он, то зачем ему использовать нож вместо его \"пистолета\"?"

# game/chapter1.rpy:3356
translate russiantl quest2_72b958a5:
    ...
    Br "Это маловероятно. " # Чисто украинское самоубийство, лол. TODO

# game/chapter1.rpy:3358
translate russiantl quest2_2d5dd7bc:

    # Br "I thought we ruled that one out already."
    Br "Я думал мы уже отмели эту версию." #TODO

# game/chapter1.rpy:3369
translate russiantl quest3_efa64f5f:

    # Br "No, just no."
    Br "Нет, просто нет."

# game/chapter1.rpy:3375
translate russiantl quest3_1cae1ee0:

    # Br "That is possible, but we have already searched the perimeter and didn't find anything."
    Br "Это возможно, но мы обыскали окрестности и ничего не нашли."

# game/chapter1.rpy:3380
translate russiantl quest3_b3035bf3:
    ...
    c "Он не хотел шуметь. В конце концов, он убежал от Маверика, пытаясь скрыться от полиции. Выстрел из оружия бы привлек к себе кучу внимания и выдал бы его местоположение."

# game/chapter1.rpy:3382
translate russiantl quest3_192dae16:

    # Br "Right, that could be a good reason."
    Br "Тут я с тобой соглашусь."

# game/chapter1.rpy:3385
translate russiantl quest3_c9a0e18a:

    # c "There clearly is no reason why he would, so it couldn't have been him at all."
    c "Очевидно что у него не было таких причин, я думаю что это не он."

# game/chapter1.rpy:3387
translate russiantl quest3_6458393e:

    # Br "I'll have to disagree with you on that."
    Br "Тут я с тобой не соглашусь." #TODO?

# game/chapter1.rpy:3393
translate russiantl quest3_54f8ce04:
    ...
    Br "Очевидно? То есть ты хочешь сказать что летун, который едва может держать в руках нож, пырял себя до тех пор пока не умер от потери крови? Это очень не правдоподобно." #TODO украинское самоубийство

# game/chapter1.rpy:3394
translate russiantl quest3_7b49274c:
...
translate russiantl quest3_56520b1b:
...
translate russiantl quest3_2d5dd7bc:

    # Br "I thought we ruled that one out already."
    Br "Я думал что мы уже отмели эту версию."

# game/chapter1.rpy:3400
translate russiantl quest3_9b65074b:

    # Br "Alright, I get it. You think it was a suicide, but I think we should explore other options."
    Br "Да понял я, понял. Ты думаешь что это было самоубийство, но давай изучим другие варианты событий."

# game/chapter1.rpy:3407
translate russiantl quest3_ba9c14f7:

    # Br "By the way, which wound do you think was the lethal one?"
    Br "Кстати, как думаешь, какая рана стала для него смертельной?"

# game/chapter1.rpy:3414
translate russiantl quest4_40a3ed0e:

    # c "The gashes on his chest look rather large. I think it was them."
    c "Порезы на её груди выглядят впечетляюще. Я думаю что это они."

# game/chapter1.rpy:3415
translate russiantl quest4_bf51c108:
    ...
    Br "На самом деле нет. эти виды ран происходят от резкого движения, а это значит, что рана может выглядеть большой, но повреждение сравнительно поверхностное." # TODO

# game/chapter1.rpy:3416
translate russiantl quest4_2d79e7a0:

    # Br "Of course they may contribute to blood loss, but they aren't lethal so quickly."
    Br "Конечно они внесли свою лепту в потерю крови, но сами по себе они не сильно смертельные." #TODO

# game/chapter1.rpy:3422
translate russiantl quest4_39b1abf3:

    # c "He's got quite a few there, so I think it must be them."
    c "У неё много ран на крыльях, я думаю что это они."

# game/chapter1.rpy:3423
translate russiantl quest4_f500d250:
    ...
    Br "Нет, от этих ран она потеряла совсем немного крови. Такие раны обычно получаются когда жертва пытается защитить себя от такого нападения." #TODO

# game/chapter1.rpy:3429
translate russiantl quest4_264bf143:

    # c "I think it was the one on his neck."
    c "Я думаю что смертельной была рана на его шее."

# game/chapter1.rpy:3430
translate russiantl quest4_00bcf583:
    ...
    Br "Правильно. Если ты еще не догадался по всей этой крови, это узкая колотая рана. Также исходя из этого можно сказать что она самая глубокая из всех."

# game/chapter1.rpy:3431
translate russiantl quest4_b628c4fd:

    # Br "And from the location, it's pretty obvious this must have done tremendous damage."
    Br "И, учитывая её расположение, довольно очевидно что она причинила огромный урон."

# game/chapter1.rpy:3435
translate russiantl quest4_f2232d68:

    # Br "What else do you see?"
    Br "Что еще ты видишь?"

# game/chapter1.rpy:3443
translate russiantl quest4_05ddcc31:

    # c "Well, there's a lot of blood."
    c "Ну, крови очень много."

# game/chapter1.rpy:3452
translate russiantl quest5_122763b9:

    # c "There's so much blood. Could he have been hemophiliac?"
    c "Тут так много крови. Мог ли он страдать гемофилией?"

# game/chapter1.rpy:3453
translate russiantl quest5_dd470157:

    # Br "It is a lot of blood, I'll give you that, but I don't think this has anything to do with hemophilia."
    Br "Да, крови тут конечно много, но я не думаю что это как-то связано с гемофилией."

# game/chapter1.rpy:3459
translate russiantl quest5_bf9677c8:

    # Br "Had what?"
    Br "У него был что?"

# game/chapter1.rpy:3460
translate russiantl quest5_d19f855d:

    # c "..."
    c "..."

# game/chapter1.rpy:3465
translate russiantl quest5_2e8a7b46:

    # c "He died here, else there would have been a trail we could follow. The splatters also suggest this is where they fought."
    c "Он умер тут, иначе остался бы кровавый след. Брызги крови также указывают на то, что они сражались именно здесь."

# game/chapter1.rpy:3469
translate russiantl quest5_0ee50d1c:

    # Br "You sure?"
    Br "Уверен?"

# game/chapter1.rpy:3472
translate russiantl quest5_f913b41f:

    # Br "No, it's blood alright."
    Br "Нет, это самая настоящая кровь."

# game/chapter1.rpy:3478
translate russiantl quest5_ac0be0ab:
...
translate russiantl quest5_9e24a4c4:
...
translate russiantl quest5_7b49274c:

    # Br "Actually, the only reason I can think of why someone would do that is if he deliberately wanted to make it look as if it wasn't a suicide."
    Br ""

# game/chapter1.rpy:3488
translate russiantl quest5_7cb5fa29:
...
translate russiantl quest5_2d5dd7bc:

    # Br "I thought we ruled that one out already."
    Br "Я думал что мы уже отмели эту версию."

# game/chapter1.rpy:3494
translate russiantl quest5_9b65074b:

    # Br "Alright, I get it. You think it was a suicide, but I think we should explore other options."
    Br ""

# game/chapter1.rpy:3497
translate russiantl quest5_ff15c714:

    # Br "Just stop it already."
    Br "Ну хватит уже."

# game/chapter1.rpy:3504
translate russiantl quest5_7c20a52f:

    # Br "That's true."
    Br "Это верно."

# game/chapter1.rpy:3505
translate russiantl quest5_7d2a0f75:

    # Br "Unfortunately, it doesn't help with determining who the perpetrator is."
    Br "Но, к сожалению, это не поможет нам установить кто совершил это приступление."

# game/chapter1.rpy:3506
translate russiantl quest5_1a76e383:

    # c "Objection!" with hpunch #obvious reference to Ace Attorney
    c "Протестую!" with hpunch

# game/chapter1.rpy:3508
translate russiantl quest5_3f970c7c:

    # Br "Excuse me?"
    Br "Прошу прощения?"

# game/chapter1.rpy:3509
translate russiantl quest5_18dd0115:

    # c "Sorry, I just always wanted to say that."
    c "Извини, всегда хотел это сказать."

# game/chapter1.rpy:3510
translate russiantl quest5_08965b6a:

    # Br "Go on, please."
    Br "Пожалуйста, продолжай."

# game/chapter1.rpy:3518
translate russiantl quest5_0c30ecb2:

    # c "What about the blood on his muzzle?"
    c "А что насчет крови на его морде?"

# game/chapter1.rpy:3519
translate russiantl quest5_fd91ea9e:

    # Br "You tell me."
    Br "А как ты думаешь?"

# game/chapter1.rpy:3530
translate russiantl quest6_6da252ec:

    # Br "Don't be silly."
    Br "Не говори групостей."

# game/chapter1.rpy:3536
translate russiantl quest6_116a375c:

    # c "It might be the perpetrator's blood."
    c "Возможно, это кровь его убийцы."

# game/chapter1.rpy:3540
translate russiantl quest6_bfce32ae:

    # Br "And have the blood from it still stuck to his teeth who knows how long after? I don't think so."
    Br ""

# game/chapter1.rpy:3546
translate russiantl quest6_6dd6c5dc:

    # Br "Possible, but unlikely."
    Br "Маловероятно, но возможно."

# game/chapter1.rpy:3552
translate russiantl quest6_ad271f6e:

    # Br "That is actually a very real possibility. We probably would be seeing more blood if that were the case, though."
    Br "Это вполне возможно, но тогда бы тут было намного больше крови." #TODO

# game/chapter1.rpy:3557
translate russiantl quest6_e9ff846e:
    ...
    Br "Да, все верно. Думаю что криминалисты уже взяли её образец, и это может помочь нам определить кто является преступником."

# game/chapter1.rpy:3558
translate russiantl quest6_b4f8e17e:

    # Br "Hm. I think that's about everything."
    Br "Ну, думаю тут все."

# game/chapter1.rpy:3580
translate russiantl quest6_09b5f048:

    # Br "You know what, kid? I'm impressed. Maybe we should have you around more often."
    Br "Знаешь что, парень? Я впечатлен. Может быть нам стоит даже нанять тебя." #TODO

# game/chapter1.rpy:3601
translate russiantl _call_syscheck_13_0ee48772:

    # s "You did well on the first investigation!"
    s "Вы хорошо справились с первым расследованием!"

# game/chapter1.rpy:3605
translate russiantl _call_syscheck_13_19e2bb77:

    # s "You did well on the first investigation. Well done."
    s "Ты хорошо справился с первым расследованием! Отличная сработано."

# game/chapter1.rpy:3609
translate russiantl _call_syscheck_13_593bcccd:

    # s "You did well on the first investigation. Achoo- I mean, achievement unlocked."
    s "Ты хорошо справился с первым расследованием! Апчхи- то есть, достижение получено." #TODO

# game/chapter1.rpy:3613
translate russiantl _call_syscheck_13_9cf7f4d5:
...
translate russiantl _call_syscheck_13_47b8d288:

    # Br "Maybe this isn't your strong suit."
    Br "Да, расследования это точно не твоя сильная сторона" #TODO?

# game/chapter1.rpy:3619
translate russiantl _call_syscheck_13_5c730655:

    # c "Told you so."
    c "Я же говорил."

# game/chapter1.rpy:3621
translate russiantl _call_syscheck_13_1cccbacd:

    # Br "Don't worry about it. We still need your help with other things."
    Br "Ладно, не бери в голову. Но нам бы не помешала помощь в других делах."

# game/chapter1.rpy:3628
translate russiantl _call_syscheck_13_b31a64f0:

    # Sb "Hey Chief, do you still need the witness here for anything?"
    Sb "Эй шеф, тебе еще нужна наша свидетель?"

# game/chapter1.rpy:3629
translate russiantl _call_syscheck_13_a62ea80e:
    ...
    m "Себастиан подошел к нам вместе с драконихой, которая обнаружила тело. Я узнал в ней Эдин, ту официантку из кафе. Она выглядила растерянной, что не было удивительно, учитывая все обстоятельста."

# game/chapter1.rpy:3630
translate russiantl _call_syscheck_13_da883f60:

    # Br "I don't think so. Take her to the department, get her statement written up and that should be it."
    Br "Нет, не думаю. Отведи её в участок, возьми у неё показания, и на этом закончим."

# game/chapter1.rpy:3631
translate russiantl _call_syscheck_13_fd0a6543:

    # Sb "Sure thing."
    Sb "Ладно."

# game/chapter1.rpy:3636
translate russiantl _call_syscheck_13_ff7c1ac6:

    # Sb "Alright, Miss, we're going to have to take you to the department."
    Sb "Девушка, Вам придеться пройти с нами в участок."

# game/chapter1.rpy:3637
translate russiantl _call_syscheck_13_356b153d:

    # Ad "Of course."
    Ad "Конечно."

# game/chapter1.rpy:3638
translate russiantl _call_syscheck_13_45c63088:

    # m "When she spotted me, however, her composure brightened visibly."
    m "Но когда она заметила меня, она заметно просияла."

# game/chapter1.rpy:3642
translate russiantl _call_syscheck_13_706f1fa0:

    # Ad "Oh, it's the human!"
    Ad "Ой, это же человек!"

# game/chapter1.rpy:3648
translate russiantl _call_syscheck_13_56659e1f:

    # Ad "Well, I'd call you by your name, but you never actually told me it."
    Ad "Ну, я бы называла тебя по имени, если бы я знала как тебя зовут."

# game/chapter1.rpy:3652
translate russiantl _call_syscheck_13_d2c48d95:

    # Ad "Actually, I don't. You never told me it."
    Ad "Вообще-то не знаю. Ты мне его не говорил."

# game/chapter1.rpy:3657
translate russiantl _call_syscheck_13_4cad1270:

    # Ad "Sorry, I'd call you by your name, but you never actually told me it."
    Ad "Извини, я бы называла тебя по имени, но ты мне его так и не сказал."

# game/chapter1.rpy:3660
translate russiantl _call_syscheck_13_4392e6f6:

    # c "It's [player_name]."
    c "Меня зовут [player_name]."

# game/chapter1.rpy:3664
translate russiantl _call_syscheck_13_d8da8674:

    # Ad "What're you even doing here? Do you work for our police now?"
    Ad "А что ты вообще тут делаешь? Ты что, теперь работаешь на полицию?"

# game/chapter1.rpy:3670
translate russiantl _call_syscheck_13_28a2f7c3:

    # Ad "That doesn't sound very convincing."
    Ad "Звучит как-то неуверенно."

# game/chapter1.rpy:3671
translate russiantl _call_syscheck_13_2b289471:

    # c "I'm not quite convinced, either."
    c "Да я и сам в этом не уверен."

# game/chapter1.rpy:3676
translate russiantl _call_syscheck_13_4e548148:

    # Ad "Maybe I should be calling you officer, then."
    Ad "Может мне стоит называть тебя офицером?" #TODO

# game/chapter1.rpy:3677
translate russiantl _call_syscheck_13_ae3b45e4:

    # c "I don't think I'm quite there yet."
    c "Не думаю что я настолько продвинулся по карьерной лестнице."

# game/chapter1.rpy:3682
translate russiantl _call_syscheck_13_fb0f5fb4:

    # Ad "Oh, you."
    Ad "" #TODOOOOOO БЛЯТЬ

# game/chapter1.rpy:3684
translate russiantl _call_syscheck_13_b3ae45a6:

    # c "By the way, I didn't know you also did deliveries."
    c "А я и не знал что ты занимаешься доставкой еды."

# game/chapter1.rpy:3686
translate russiantl _call_syscheck_13_8d9339b1:

    # Ad "I do a little bit of everything, really."
    Ad "Вообще, я занимаюсь всем понемножку."

# game/chapter1.rpy:3689
translate russiantl _call_syscheck_13_d037c931:

    # c "That's nice. I liked my uh... fish yesterday."
    c "Здорово. Вчера мне понравилась моя эээ... рыба."

# game/chapter1.rpy:3691
translate russiantl _call_syscheck_13_31e4b909:

    # Ad "You don't have to hide it. I know it's quite an acquired taste."
    Ad "Да ладно тебе, можешь не притворяться. Вкус на любителя, сама знаю."

# game/chapter1.rpy:3693
translate russiantl _call_syscheck_13_82b2ebf7:

    # Ad "To be fair, I wouldn't have recommended it to someone new like you, but you could always try something different."
    Ad "Если честно, я бы не советовала пробовать её в качестве самого первого блюда в нашем ресторане, но, знаешь ведь, всегда можно попробовать что-то новенькое."

# game/chapter1.rpy:3695
translate russiantl _call_syscheck_13_306d0a40:

    # Ad "Here's our number if you don't want to come in and we'll deliver anything we have to you."
    Ad "Вот наш номер телефона, на случай если тебе не захочется идти в ресторан, мы можем доставить всё что у нас есть на дом."

# game/chapter1.rpy:3698
translate russiantl _call_syscheck_13_a6533cae:

    # c "That's nice. I liked my coffee yesterday."
    c "Мне понравился вчерашний кофе." #TODO

# game/chapter1.rpy:3699
translate russiantl _call_syscheck_13_d9da18f9:
...
translate russiantl _call_syscheck_13_7ee27cc1:

    # c "That's nice. I loved my scrambled eggs yesterday."
    c "Мне понравился вчерашний омлет."

# game/chapter1.rpy:3703
translate russiantl _call_syscheck_13_eef70e34:
...
translate russiantl _call_syscheck_13_dd20ffbf:

    # c "Thanks."
    c "Благодарю."

# game/chapter1.rpy:3711
translate russiantl _call_syscheck_13_903f6637:

    # Sb "..."
    Sb "..."

# game/chapter1.rpy:3712
translate russiantl _call_syscheck_13_ac0c64de:

    # Ad "Sorry, I guess we should get going. Bye!"
    Ad "Извини, но похоже нам уже пора. Пока!"

# game/chapter1.rpy:3721
translate russiantl _call_syscheck_13_59f4c3db:

    # c "What do we do now?"
    c "И что нам делать теперь?"

# game/chapter1.rpy:3725
translate russiantl _call_syscheck_13_3a0907aa:

    # Br "I suppose we'll head off too, unless- oh no."
    Br "Наверное нам тоже нужно пойти в полицейский участо- о нет."

# game/chapter1.rpy:3726
translate russiantl _call_syscheck_13_0f173ebb:

    # c "What is it?"
    c "Что такое?"

# game/chapter1.rpy:3732
translate russiantl _call_syscheck_13_00d1c811:
    ...
    Mv "У нас на руках убийство, и конечно же, мне даже никто об этом не сказал. Я бы и не узнал, если бы не сосед который у меня о нём спросил. Хорошо что слухи быстро расходятся, не так ли?"

# game/chapter1.rpy:3736
translate russiantl _call_syscheck_13_df144435:

    # Br "Of course nobody told you. You're on sick leave. Mandatory sick leave, I might add."
    Br "Конечно же тебе никто не сказал, ты же на больничном. На {i}принудительном{/i} больничном."

# game/chapter1.rpy:3737
translate russiantl _call_syscheck_13_a8193667:
    ...
    Mv "Вообще я тут по своим делам. Я просто наслаждался прогулкой на свежем воздухе, и случайно наткнулся на вас."

# game/chapter1.rpy:3738
translate russiantl _call_syscheck_13_beb3f735:

    # Br "What do you want?"
    Br "Что тебе нужно?"

# game/chapter1.rpy:3739
translate russiantl _call_syscheck_13_6e94227f:
    ...
    Mv "Да так, ничего. Просто вот какая занимательная штука получается: мне об этом даже никто не сказал, но дружок главного подозреваемого может шастать по месту преступления." #TODO

# game/chapter1.rpy:3740
translate russiantl _call_syscheck_13_770d320f:

    # Br "I know what you are thinking, but don't jump to conclusions here."
    Br "Я знаю что ты подумал, но давай не будем делать поспешных выводов."

# game/chapter1.rpy:3741
translate russiantl _call_syscheck_13_c1c6fd1f:

    # Mv "I don't need to jump to conclusions, I think the dead body we found says it all."
    Mv "Я их и не делаю, я уже и так все знаю." #TODO? ИЛЬЯ ГДЕ ЖЕ ТЫ Я НЕ ЗНАЮ КАК ЭТУ ХУЙНЮ ПЕРЕВОДИТЬ ААА

# game/chapter1.rpy:3742
translate russiantl _call_syscheck_13_e73d0e45:
    ...
    Br "У тебя действительно проблемы с поведением. Знаешь, если бы ты не был на больничном, тебя бы давно уже задержали за нападение на посла вчара. Ты хоть понимаешь к каким последствиям это могло привести?" #TODO

# game/chapter1.rpy:3743
translate russiantl _call_syscheck_13_fcd88baa:
    ...
    Mv "Я напал на посла? С моей точки зрения, напали как раз таки на меня. И уж извините меня что я " #TODO

# game/chapter1.rpy:3744
translate russiantl _call_syscheck_13_cf1f1ec2:

    # Mv "Right, let's just all sit idly by while the suspect's on the loose and planning his next move."
    Mv "Да, давайте просто сидеть и ждать пока преступник на свободе и планирует свой следующий шаг."

# game/chapter1.rpy:3745
translate russiantl _call_syscheck_13_35cc0675:

    # c "You know, whatever it was Reza was talking about, he was going to tell me just before you showed up yesterday."
    c "Знаешь, если бы ты вчера не обьявился, Реза бы сказал мне то что хотел." #TODO

# game/chapter1.rpy:3747
translate russiantl _call_syscheck_13_d6e3dd96:

    # Mv "I don't need to hear you, of all people, belittling me about this."
    Mv "" #TODO ты уж помолчал бы

# game/chapter1.rpy:3748
translate russiantl _call_syscheck_13_8f8ef8cb:

    # c "What's your problem? If anything, I want to find him just as much as you do."
    c "Да что с тобой не так? Я его тоже хочу найти, между прочим."

# game/chapter1.rpy:3749
translate russiantl _call_syscheck_13_457fcea1:

    # Mv "Don't compare yourself to me. Your words mean nothing."
    Mv "Даже не смей сравнивать нас между собой. Твои слова для меня ничего не значат." #TODO?

# game/chapter1.rpy:3753
translate russiantl _call_syscheck_13_5cf10feb:

    # Br "Enough. You shouldn't even be here, so you better go now and get some rest before I have to take disciplinary action."
    Br "Довольно. Тебя даже не должно тут быть, так что иди отдохни пока я не принял меры." #TODO?

# game/chapter1.rpy:3754
translate russiantl _call_syscheck_13_fa395534:

    # Mv "Fine, but when we find him, you'll see I was right. If I have to prove it myself, so be it."
    Mv "Ладно, но когда мы его найдем вы увидите что я был прав. И я это докажу, чего бы мне это не стоило." #TODO

# game/chapter1.rpy:3763
translate russiantl _call_syscheck_13_f1d1df9e:

    # c "Can he even just do his own investigation like that?"
    c "А он вообще имеет право так делать?"

# game/chapter1.rpy:3764
translate russiantl _call_syscheck_13_13ab97f3:

    # Br "Well, as long as he doesn't interfere with us, we can't really stop him from doing things in his own free time."
    Br "Ну, пока он не мешает ходу нашего расследования, мы не можем запретить ему заниматся тем чем он хочет в свободное время." #TODO

# game/chapter1.rpy:3765
translate russiantl _call_syscheck_13_ff7d6620:

    # c "I see. I suspect he won't adhere to the standards of performing an unbiased investigation, though."
    c "Понятно. Что-то мне подсказывает что он не собирается быть непредвзятым " #TODO

# game/chapter1.rpy:3766
translate russiantl _call_syscheck_13_e7fb449d:
    ...
    Br "Он уже все решил. Мне ясно что он не будет докапываться до правды, а будет просто искать доказательства, поддерживающие его точку зрения. " #TODO

# game/chapter1.rpy:3767
translate russiantl _call_syscheck_13_db3eef0e:

    # Br "He's always been like that, always something to prove. We'll have to be careful. He'll be looking for Reza soon enough."
    Br "Он всегда таким был, вечно надо что-то кому-то доказывать. Нам нужно быть осторожными. Он тоже будет искать Резу." #TODO

# game/chapter1.rpy:3770
translate russiantl _call_syscheck_13_4bf4438d:

    # Br "Yeah, and that's exactly why he wouldn't be on the case even if he wasn't on sick leave."
    Br "Ага, и именно по этому ему бы не получили расследовать это дело даже если бы он не был на больничном." #TODO

# game/chapter1.rpy:3773
translate russiantl _call_syscheck_13_de4291be:

    # Br "Yeah."
    Br "Это уж точно."

# game/chapter1.rpy:3778
translate russiantl _call_syscheck_13_138bdb5d:

    # Br "Don't worry, Reza will turn up eventually."
    Br "Не беспокойся, Реза рано или поздно все равно обьявится."

# game/chapter1.rpy:3779
translate russiantl _call_syscheck_13_d219e599:

    # c "I surely hope so."
    c "Очень на это надеюсь."

# game/chapter1.rpy:3780
translate russiantl _call_syscheck_13_f6aa8926:
    ...
    m "Учитывая все обстоятельства, мне нужно было признать что возможно Маверик даже был прав. Но мог ли тот Реза которого я знал, пойти на такое?"

# game/chapter1.rpy:3781
translate russiantl _call_syscheck_13_cbde794f:
    ...
    Br "Знаешь, если ты вспомнишь что-то что может помочь с расследованием, или тебе что-то понадобиться, позвони мне, ладно?"

# game/chapter1.rpy:3782
translate russiantl _call_syscheck_13_255ecca1:

    # c "I will."
    c "Обязательно." #TODO без сарказма.

# game/chapter1.rpy:3783
translate russiantl _call_syscheck_13_46e457aa:

    # Br "Well, I think we're done here. Let's go."
    Br "Ну, думаю тут мы закончили. Пойдем." #TODO

# game/chapter1.rpy:3792
translate russiantl sceneselect_703d4088:
    ...
    m "Брюс отвел меня к дому. Наверное для меня не нашлось никаких дел. Может мне даже следывало быть благодарным за это." #TODO

# game/chapter1.rpy:4093
translate russiantl chapter1chars_64789417:

    # c "(What should I do?)" nointeract
    c "(Чем бы мне заняться?)" nointeract

# game/chapter1.rpy:4141
translate russiantl chapter1chars_4c8433ce:

    # c "(More free time. What should I do?)" nointeract
    c "(Больше свободного времени. Чем бы мне теперь заняться?)" nointeract #TODO

# game/chapter1.rpy:4185
translate russiantl chapter1chars_a98cb5b8:
    ...
    m "В конце концо я решил провести остаток дня отдыхая в своей квартире. Я не знал когда все это продолжится, и решил отдыхать пока могу." #TODO
...
translate russiantl strings:
    ...
    new "Пожалуйста, введите своё имя:"

    # chapter1.rpy:108
    old "{color=#0000ff}B{/color}lue"
    new "{color=#0000ff}С{/color}иний"

    # chapter1.rpy:108
    old "{color=#ff0000}R{/color}ed"
    new "{color=#ff0000}К{/color}расный"

    # chapter1.rpy:108
    old "{color=#ffff00}Y{/color}ellow"
    new "{color=#ffff00}Ж{/color}ёлтый"

    # chapter1.rpy:108
    old "{color=#008000}G{/color}reen"
    new "{color=#008000}З{/color}елёный"

    # chapter1.rpy:108
    old "{color=#d3d3d3}G{/color}ray"
    new "{color=#d3d3d3}С{/color}ерый"
    ...
    new "{color=#00ffff}Г{/color}олубой"

    # chapter1.rpy:163
    old "{color=#ff00ff}M{/color}agenta"
    new "{color=#ff00ff}П{/color}урпурный"

    # chapter1.rpy:163
    old "{color=#00ff00}L{/color}ime"
    new "{color=#00ff00}Л{/color}аймовый"

    # chapter1.rpy:163
    old "{color=#ffa500}O{/color}range"
    new "{color=#ffa500}О{/color}ранжевый"

    # chapter1.rpy:163
    old "{color=#ffffff}W{/color}hite"
    new "{color=#ffffff}Б{/color}елый"

    # chapter1.rpy:226
    old "{color=#ffd700}G{/color}old"
    new "{color=#ffd700}З{/color}олотой"

    # chapter1.rpy:226
    old "{color=#c0c0c0}S{/color}ilver"
    new "{color=#c0c0c0}С{/color}еребристый"

    # chapter1.rpy:226
    old "{color=#b5a642}B{/color}rass"
    new "{color=#b5a642}Л{/color}атунный"

    # chapter1.rpy:226
    old "{color=#cd7f32}B{/color}ronze"
    new "{color=#cd7f32}Б{/color}ронзовый"

    # chapter1.rpy:226
    old "{color=#cb6d51}C{/color}opper"
    new "{color=#cb6d51}М{/color}едный"

    # chapter1.rpy:289
    old "{color=#808000}O{/color}live"
    new "{color=#808000}О{/color}ливковый"

    # chapter1.rpy:289
    old "{color=#8b4513}B{/color}rown"
    new "{color=#8b4513}К{/color}оричневый"

    # chapter1.rpy:289
    old "{color=#008080}T{/color}eal"
    new "{color=#008080}Б{/color}ирюзовый"

    # chapter1.rpy:289
    old "{color=#800080}P{/color}urple"
    new "{color=#800080}Ф{/color}иолетовый"

    # chapter1.rpy:289
    old "{color=#800000}M{/color}aroon"
    new "{color=#800000}Б{/color}ордовый"

    # chapter1.rpy:737
    old "I felt the responsibility placed on my shoulders."
    new "Я чувствовал ответственность, возложенную на мои плечи."

    # chapter1.rpy:737
    old "I was eager for the adventure to come."
    new "Мне не терпелось встретить приключения."
    ...
    new "Не пожимать его руку."

    # chapter1.rpy:1261
    old "Kiss his hand."
    new "Поцеловать его руку."

    # chapter1.rpy:1328
    old "I bet he'd win in a fight with mine, though."
    new "Ставлю на то, что он бы смог одолеть моего в битве." #TODO
    ...
    new "Постой, дай-ка мне надеть шапочку из фольги." #TODO?
    ...
    new "Он не выглядит таким уж и плохим." #TODO
...
#    new "[[Промолчать.]"
    ...
    old "Actually, I do."
    new "Как раз таки против." #TODO
    # chapter1.rpy:1888
    old "How nice of you."
    new "Как мило с твоей стороны."
    ...
    new "Прочитать между строк"

    # chapter1.rpy:2135
    old "Look elsewhere for hints."
    new "Поискать подсказки в другом месте."

    # chapter1.rpy:2144
    old "Plan Sebastian's Murder."
    new "Спланировать убийство Себастиана."

    # chapter1.rpy:2144
    old "Do nothing while he figures out what to do."
    new "Ничего не предпринимать пока он не разузнает что делать дальше."

    # chapter1.rpy:2144
    old "Find out more about their government."
    new "Узнать больше об их правительстве."

    # chapter1.rpy:2144
    old "Flee through the portal as soon as possible."
    new "Как можно скорее сбежать через портал."

    # chapter1.rpy:2144
    old "[[Look at the letter again.]"
    new "[[Снова взглянуть на письмо.]"

    # chapter1.rpy:2144
    old "[[Show more options.]"
    new "[[Показать больше вариантов.]"

    # chapter1.rpy:2202
    old "Have a pizza party."
    new "Устроить вечеринку с пиццей."

    # chapter1.rpy:2202
    old "Steal a certain book from the library."
    new "Украсть определенную книгу из библиотеки."

    # chapter1.rpy:2202
    old "Find out where Maverick lives."
    new "Разузнать где живет Маверик."

    # chapter1.rpy:2202
    old "Break into the manufacturing plant."
    new "Вломиться на завод." #TODO?

    # chapter1.rpy:2202
    old "[[I am unable to decode the message.]"
    new "[[Я не могу разшифровать это сообщение.]"

    # chapter1.rpy:2293
    old "Look at the bookshelf."
    new "Посмотреть на книжную полку."
    ...
    new "Посмотреть на кухне."

    # chapter1.rpy:2301
    old "Look at an individual book."
    new "Посмотреть на определенную книгу."

    # chapter1.rpy:2301
    old "Look behind the books."
    new "Посмотреть за книгами."
    ...
    new "Нападение Гуманоидов из Открытого Космоса"

    # chapter1.rpy:2339
    old "Born to Serve"
    new "Рожден чтобы Служить"
    ...
    new "Сфера Иксомен и её применения." #TODO

    # chapter1.rpy:2480
    old "Look inside the cabinet."
    new "Заглянуть в шкафчик."
    ...
    # chapter1.rpy:2488
    old "Take some."
    new "Выпить несколько штук."

    # chapter1.rpy:2573
    old "Look in the fridge."
    new "Заглянуть в холодильник."

    # chapter1.rpy:2573
    old "Look in the pantry."
    new "Заглянуть в буфет."

    # chapter1.rpy:2578
    old "Look at the meat."
    new "Посмотреть на мясо."

    # chapter1.rpy:2578
    old "Look at the milk."
    new "Посмотреть на молоко."

    # chapter1.rpy:2578
    old "Crack open an egg and look inside."
    new "Разбить яйцо и посмотреть внутрь."

    # chapter1.rpy:2578
    old "Examine an unlabeled container."
    new "Осмотреть неподписаный контейнер."
    ...
    # chapter1.rpy:2811
    old "Guess I did."
    new "Но я все-таки пришел."

    # chapter1.rpy:2811
    old "What did you expect?"
    new "А чего ты ожидал?"

    # chapter1.rpy:2811
    old "Well, you didn't make it easy."
    new "Ну, твоя загадка была не из легких."
    ...
    new "Да говори уже быстрее!"

    # chapter1.rpy:2949
    old "Still feeling a little dizzy."
    new "У меня еще кружится голова."

    # chapter1.rpy:2949
    old "I think I'm alright."
    new "Думаю что да." #TODO

    # chapter1.rpy:2960
    old "Reza shot Maverick and ran off."
    new "Реза выстрелил в Маверика и убежал."

    # chapter1.rpy:2960
    old "Maverick followed us here and tried to apprehend us."
    new "Маверик проследил за нами, и пытался нас задержать."

    # chapter1.rpy:3073
    old "Maybe they both acted in the heat of the moment."
    new "Возможно они оба действовали в состоянии аффекта."

    # chapter1.rpy:3073
    old "Where I come from, this kind of attack on a diplomat could be classified as an act of war, punishable by death."
    new "Там, откуда я родом, такое нападание на дипломата разценивалось бы как акт агрессии, карающийся смертной казнью."

    # chapter1.rpy:3073
    old "I hope so."
    new "Очень на это надеюсь."

    # chapter1.rpy:3154
    old "I respectfully decline."
    new "Я вежливо откажусь."
    ...
    # chapter1.rpy:3207
    old "Just do it."
    new "Давай уже покончим с этим."

    # chapter1.rpy:3296
    old "They were inflicted with a sharp implement."
    new "Они были нанесены острым инструментом."

    # chapter1.rpy:3296
    old "The perpetrator was an unusually large or small person."
    new "Преступник был необычайно велик или мал." #TODO

    # chapter1.rpy:3296
    old "He was already dead when he got these wounds."
    new "Он был уже мертв, когда получил эти ранения."
    ...
    new "Драконы не используют ножей."

    # chapter1.rpy:3327
    old "It couldn't have been Reza."
    new "Это не мог быть Реза."

    # chapter1.rpy:3327
    old "It could have only been someone with hands."
    new "Это мог быть только кто-то у которого есть руки."

    # chapter1.rpy:3327
    old "It tells us that it was suicide."
    new "Это указывает на то, что это было самоубийство."

    # chapter1.rpy:3367
    old "It makes him look cooler."
    new "Так он кажется круче." #TODO

    # chapter1.rpy:3367
    old "He lost his gun."
    new "Он потерял свой пистолет."

    # chapter1.rpy:3367
    old "He did not want to make any noise."
    new "Он не хотел шуметь."

    # chapter1.rpy:3367
    old "He wouldn't, because it wasn't him."
    new "Он его и не использовал, потому что это был не он." #TODO

    # chapter1.rpy:3367
    old "He wouldn't, because this was clearly a suicide."
    new "Он его и не использовал, потому что очевидно что это самоубийство." #TODO
    ...
    new "Брызги крови указывают на то, что:"

    # chapter1.rpy:3448
    old "He was hemophiliac."
    new "Он страдал гемофилией."
    ...
    new "После того как он умер, тело перетащили сюда."

    # chapter1.rpy:3448
    old "He committed suicide."
    new "Он совершил самоубийство."

    # chapter1.rpy:3524
    old "The blood on his muzzle suggests that:"
    new "Кровь на его морде указывает на то, что:"
    ...
    # chapter1.rpy:3524
    old "He fought back."
    new "Он пытался отбиваться."

    # chapter1.rpy:3524
    old "He had a bloody steak earlier."
    new "Ранее он съел стейк с кровью."

    # chapter1.rpy:3524
    old "He has gum disease."
    new "У него было заболевание дёсен."

    # chapter1.rpy:3524
    old "He bit his tongue during the fight."
    new "Он прикусил язык во время драки."

    # chapter1.rpy:3644
    old "Well, I'm {i}a{/i} human."
    new "Угадала, я человек."

    # chapter1.rpy:3644
    old "I have a name, you know."
    new "У меня же имя есть, знаешь?"
    ...
    # chapter1.rpy:3666
    old "Guess so."
    new "Думаю что да."  #TODO PASS?

    # chapter1.rpy:3666
    old "Looks like it."
    new "Получается что так."

    # chapter1.rpy:3666
    old "No, it's just a hobby."
    new "Нет, это просто хобии."

    # chapter1.rpy:3768
    old "To be fair, I might be too if I was shot."
    new "На его месте я бы сделал то же самое." #TODO

    # chapter1.rpy:3768
    old "Let's hope we find Reza before he does."
    new "Давай надеяться на то, что мы найдем Резу раньше него."

    # chapter1.rpy:3768
    old "At least that means someone will find him, right?"
    new "Ну, хотя бы кто-то его найдет." #TODO
    ...
    new "Получить заслуженный отдых." #TODO
