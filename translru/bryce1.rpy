...
translate russiantl bryce1_035da1b9:
    ...
    m "Я довольно быстро нашёл Брайса, он оказался в своём офисе."
...
translate russiantl bryce1_0ccc8efa:
    ...
    c "Всё хорошо. Ты сказал мне связаться с тобой, если я вспомню что-нибудь, что может помочь расследованию."
...
translate russiantl bryce1_d22825cb:
    ...
    Br "Знаешь, я почти закончил работу в офисе на сегодня, но если ты хочешь обсудить это всё за кружечкой пива или ещё чего, то я буду более чем рад."

# game/bryce1.rpy:54
translate russiantl bryce1_984c5d7f:

    # Br "That's fine, you don't have to."
    Br "Не переживай, это необязательно"
...
# game/bryce1.rpy:90
translate russiantl bryce1_dd027f19:

    # n "My meeting with Bryce ended before it even had a chance to pick up."
    n "Моя встреча с Брайсом окончилась, не успев даже начаться."

# game/bryce1.rpy:91
translate russiantl bryce1_2bc32794:

    # n "How could that be?"
    n "Как так получилось?"

# game/bryce1.rpy:92
translate russiantl bryce1_d0bb4d07:
...
translate russiantl _call_syscheck_37_8b86f8ee:
    ...
    s "Вы отклонили приглашение Брайса. Почему? Да кто бы знал."
...
translate russiantl _call_syscheck_37_806ce7c2:
    ...
    nvl clear
    n "Может, я и не самый мудрый человек всех времён и народов, но уж что я знаю наверняка, так это то, что злить огромного дракона - не самая лучшая идея."
...
translate russiantl _call_skipcheck_8_1e2e13a9:
    ...
    c "А ты часто сюда наведываешься?"

# game/bryce1.rpy:292
translate russiantl _call_skipcheck_8_6e8bd520:

    # Br "Sometimes."
    Br "Временами."

# game/bryce1.rpy:298
translate russiantl _call_skipcheck_8_af6195fc:

    # Wr "Hey, you two. What can I bring you?"
    Wr "Эй, вы двое. Что вам принести?"

# game/bryce1.rpy:299
translate russiantl _call_skipcheck_8_39d68eb9:
...
translate russiantl waitmenu_e9b001dc:
    ...
    c "Только одно мне кажется необычным во всех этих событиях: в ресторане, когда он сказал мне про письмо, то он упомянул, что я точно смогу понять секретное послание."
...
translate russiantl waitmenu_fbab1a19:
    ...
    c "Конечно нет. Я ничего даже не подозревал."

# game/bryce1.rpy:360
translate russiantl waitmenu_6377318a:

    # Br "That is quite peculiar."
    Br "Да, это довольно странно."
...
translate russiantl waitmenu_96107e98:
    ...
    c "И почему Маверику вообще было разрешено читать нашу личную переписку?"
...
translate russiantl waitmenu_e4f09413:
    ...
    m "И как только мне начало казаться, что сейчас наступит неловкое молчание, Брайс заметил официанта и тут же заговорил."
...
# game/bryce1.rpy:400
translate russiantl waitmenu_8725758a:

    # c "Maybe I should be going now."
    c "Наверно, мне пора идти."
...
# game/bryce1.rpy:409
translate russiantl waitmenu_5b2c4c42:
...
translate russiantl waitmenu_a89274f8:
    ...
    Br "Сам себе услугу оказываешь."

# game/bryce1.rpy:423
translate russiantl waitmenu_ae19ebaf:

    # c "I really think I should be going."
    c "Мне действительно пора идти."
...
# game/bryce1.rpy:430
translate russiantl waitmenu_74d8976a:

    # n "Without another word, I got up from my seat and left."
    n "Не сказав больше ничего, я поднялся со своего места и ушёл."
...
# game/bryce1.rpy:458
translate russiantl _call_syscheck_39_0f40089b:
...
# game/bryce1.rpy:466
translate russiantl _call_syscheck_39_8b86f8ee:

    # s "You rejected Bryce's invitation. Why is anyone's guess."
    s "Вы отклонили приглашение Брайса. Почему? Да кто бы знал."

# game/bryce1.rpy:486
translate russiantl _call_syscheck_39_0b6bf5ef:

    # Br "That's a shame, but I won't stop you."
    Br "Жалко, конечно, но я не буду тебя останавливать."

# game/bryce1.rpy:488
translate russiantl _call_syscheck_39_76b2fe88:

    # nvl clear
    nvl clear

# game/bryce1.rpy:491
translate russiantl _call_syscheck_39_09439738:

    # n "Bryce respected my wishes, but staying there longer and getting drunk wasn't exactly my idea of fun."
    n "Брайс уважил мои желания, так как напиться в баре кажется мне не слишком весёлым."

# game/bryce1.rpy:492
translate russiantl _call_syscheck_39_54a8b257:

    # n "I could certainly enjoy myself without alcohol and those who partook in its consumption."
    n "Я могу развлечься и без алкоголя и собутыльников."

# game/bryce1.rpy:493
translate russiantl _call_syscheck_39_09e57abf:

    # n "After all, there were still plenty of interesting novels waiting for me in my apartment."
    n "В конце концов, у меня в апартментах ещё такая куча непрочитанных книг, что с ума сойти."

# game/bryce1.rpy:495
translate russiantl _call_syscheck_39_76b2fe88_1:

    # nvl clear
    nvl clear

# game/bryce1.rpy:516
translate russiantl _call_syscheck_40_0f40089b:
...
# game/bryce1.rpy:567
translate russiantl _call_syscheck_40_38331395:

    # Br "That's what I like to hear."
    Br "Вот это мне нравится."
...
translate russiantl _call_syscheck_41_60623633:
    ...
    Br "И да будет победителем тот, кто больше в себя вольёт. Это игра настоящих королей, поверь мне."

# game/bryce1.rpy:652
translate russiantl _call_syscheck_41_dcc2b9e2:
...
# game/bryce1.rpy:693
translate russiantl _call_syscheck_41_fa181c86:

    # Br "That brought out your fighting spirit, huh? I like that."
    Br "Что, наконец проявился дух бойца? Одобряю."

# game/bryce1.rpy:696
translate russiantl _call_syscheck_41_506f977e:

    # c "Yeah, I can't stand another drink of this. You win."
    c "Да, я не могу больше это пить. Ты победил."
...
translate russiantl _call_syscheck_41_daee519a:
    ...
    c "Смейся сколько хочешь, мне всё равно."
...
# game/bryce1.rpy:706
translate russiantl _call_syscheck_41_f8c413c3:
...
translate russiantl _call_syscheck_41_76e9ea22:
    ...
    n "Я сыграл в его глупую игру, а он всё равно недоволен."

# game/bryce1.rpy:709
translate russiantl _call_syscheck_41_60dca1b0:

    # n "Guess he could play it without me in the future."
    n "Что ж, пусть играет и дальше, только без меня."

# game/bryce1.rpy:711
translate russiantl _call_syscheck_41_76b2fe88_1:
...
# game/bryce1.rpy:743
translate russiantl _call_syscheck_41_6b6f6d3f:

    # Br "Don't lie to me. I can see it in your face. Unless that's blushing I see and not the alcohol."
    Br "Не ври мне. Я вижу по твоему лицу. Или ты стесняешься чего-то?"
...
# game/bryce1.rpy:767
translate russiantl _call_syscheck_41_2a421450:

    # Br "Anyways, how do you like it here so far? I mean, compared to wherever it is that you came from."
    Br "В любом случае, как тебе тут, нравится? В смысле, если сравнивать с тем, откуда ты пришёл."

# game/bryce1.rpy:774
translate russiantl _call_syscheck_41_1b059110:

    # Br "We'll see how much you like it when I've drunk you under the table."
    Br "Скажешь это же, когда я буду вытаскивать тебя упавшего из-под стола."

# game/bryce1.rpy:777
translate russiantl _call_syscheck_41_1af65026:

    # Br "Good to hear. Maybe next time we'll send a dragon over to your world."
    Br "Рад слышать. Может, в следующий раз и мы пошлём дракона в ваш мир."

# game/bryce1.rpy:778
translate russiantl _call_syscheck_41_3f8630a1:

    # c "That could be... interesting."
    c "Это было бы... интересно."

# game/bryce1.rpy:784
translate russiantl _call_syscheck_41_307060d5:

    # Br "Can't fault you for that. Home is where the heart is, after all."
    Br "Не могу винить тебя за это. Дом там, где твоё сердце, в конце концов."
...
# game/bryce1.rpy:799
translate russiantl _call_syscheck_41_bfc25fda:

    # Wr "Here you go. Having ourselves a little contest, are we?"
    Wr "Вот, держите. Устроили небольшое соревнование, да?"

# game/bryce1.rpy:803
translate russiantl _call_syscheck_41_6750091c:

    # Br "You know how it goes."
    Br "Ты знаешь, что да как."

# game/bryce1.rpy:804
translate russiantl _call_syscheck_41_328d1873:

    # Wr "That I do."
    Wr "О да."

# game/bryce1.rpy:805
translate russiantl _call_syscheck_41_3da409e2:

    # Wr "Be careful, [player_name]. He's a pro."
    Wr "Осторожнее, [player_name]. Он профессионал."
...
translate russiantl _call_syscheck_41_f828523f:
    ...
    Xi "Понял, принял. Развлекайтесь!"

# game/bryce1.rpy:842
translate russiantl _call_syscheck_41_4ae87edc:

    # c "(Of course he wouldn't have challenged me if he wasn't confident he would win. Guess I'll just have to try my best.)"
    c "(Конечно, он бы не стал соревноваться, если бы не был уверен в своей победе. Похоже, придётся стараться изо всех сил.)"
...
translate russiantl _call_syscheck_41_4bbd42f0:
    ...
    m "Как только я поднёс стакан к своим губам и начал пить, то сразу же почувствовал, насколько тяжелее первого раунда давался мне этот."
...
translate russiantl _call_syscheck_41_440c57d9:
    ...
    m "Но это соревнование было не о том, чтобы всё осталось внутри."

# game/bryce1.rpy:853
translate russiantl _call_syscheck_41_137a1023:

    # c "There. Your... turn."
    c "Всё. Твоя... очередь."

# game/bryce1.rpy:857
translate russiantl _call_syscheck_41_18fc96e2:

    # Br "Did I see you struggling there for a second?"
    Br "Неужели кто-то только что дал слабину?"
...
# game/bryce1.rpy:894
translate russiantl _call_syscheck_41_2cee51b3:
    ...
    Br "А теперь я хочу спросить у тебя. Я знаю, что ты хотел мне рассказать кое-что о Резе, но неужели это была единственная причина встретиться со мной?"

# game/bryce1.rpy:900
translate russiantl _call_syscheck_41_1343658b:

    # Br "Guess you got more outta this than you asked for, then."
    Br "Ну, значит, ты получил даже больше, чем хотел."

# game/bryce1.rpy:906
translate russiantl _call_syscheck_41_8ae23095:

    # Br "I see."
    Br "А, ясно."

# game/bryce1.rpy:912
translate russiantl _call_syscheck_41_110a5d5b:

    # Br "Thought so. I won't disagree with that."
    Br "Так и знал. Ну, с этим не поспоришь."

# game/bryce1.rpy:916
translate russiantl _call_syscheck_41_948c0f54:

    # Br "Waiter, next round."
    Br "Официант, ещё по одной."

# game/bryce1.rpy:920
translate russiantl _call_syscheck_41_d869031f:

    # Wr "Coming."
    Wr "Уже несу."

# game/bryce1.rpy:927
translate russiantl _call_syscheck_41_041b5676:

    # Wr "There you go."
    Wr "Держите."

# game/bryce1.rpy:928
translate russiantl _call_syscheck_41_fee7d54c:

    # Br "Thanks."
    Br "Спасибо."

# game/bryce1.rpy:929
translate russiantl _call_syscheck_41_1c2ac3fc:
...
# game/bryce1.rpy:939
translate russiantl _call_syscheck_41_5bf1104f:

    # Br "Was it your turn... or is it my turn?"
    Br "Погоди, сейчас твоя очередь... или моя очередь?"

# game/bryce1.rpy:941
translate russiantl _call_syscheck_41_3df34601:

    # c "It's yours."
    c "Твоя."

# game/bryce1.rpy:945
translate russiantl _call_syscheck_41_467820d0:

    # Br "Alright."
    Br "Ладушки."

# game/bryce1.rpy:949
translate russiantl _call_syscheck_41_88e66bd2:
    ...
    m "К этому моменту стало очевидно, что Брайс теряет уверенность, хотя он всё ещё справлялся лучше меня. Ему даже пришлось сделать остановку, потому что он не смог выпить всё одним залпом."
...
translate russiantl _call_syscheck_41_34d7e99f:
    ...
    m "Хоть и с несколькими остановками, но у меня получилось выпить всё, однако уверенность в том, что я могу выпить ещё хоть стакан, была минимальна."
...
translate russiantl _call_syscheck_41_d748282a:
    ...
    Br "Хотя мы можем засчитать... если ты слижешь всё разлитое."

# game/bryce1.rpy:982
translate russiantl _call_syscheck_41_2321cd89:

    # Br "I can see you're close. Just a question of time now, sonny."
    Br "Я вижу, что ты близок к поражению. Теперь это просто вопрос времени, сынок."
...
translate russiantl _call_syscheck_41_849c8d53:
    ...
    c "М-можно... тебя спросить?"

# game/bryce1.rpy:995
translate russiantl _call_syscheck_41_e4ec6fd8:
...
translate russiantl _call_syscheck_41_69eb40b5:

    # c "Yah."
    c "Ага."

# game/bryce1.rpy:1019
translate russiantl _call_syscheck_41_18a959c3:

    # Br "Waiter... next round."
    Br "Официант... ещё по одной."

# game/bryce1.rpy:1026
translate russiantl _call_syscheck_41_4e68104e:

    # Wr "There you are."
    Wr "Держите."

# game/bryce1.rpy:1035
translate russiantl _call_syscheck_41_5d7755ef:
    ...
    m "Дракон посмотрел на меня сонными глазами, явно уже неспособный сосредоточить взгляд на чём-либо. Было видно, что он уже почти достиг своего лимита, хотя не сказать, что моё состояние было другим. Может, нужно было продержаться ещё совсем чуть-чуть..."

# game/bryce1.rpy:1036
translate russiantl _call_syscheck_41_9a4d9444:

    # Br "Whose turn is it even?"
    Br "Слушай, а чья сейчас очередь?"

# game/bryce1.rpy:1043
translate russiantl _call_syscheck_41_e7876ba6:

    # Br "I think... it's yours, though..."
    Br "А по-моему... по-моему твоя."

# game/bryce1.rpy:1044
translate russiantl _call_syscheck_41_570aa8e7:

    # c "Very well."
    c "Ладно."

# game/bryce1.rpy:1050
translate russiantl _call_syscheck_41_259dd404:

    # Br "Good."
    Br "Отлично."

# game/bryce1.rpy:1055
translate russiantl _call_syscheck_41_5c73dec9:

    # Br "I'm positive it's yours."
    Br "Мне кажется, что твоя."

# game/bryce1.rpy:1056
translate russiantl _call_syscheck_41_570aa8e7_1:

    # c "Very well."
    c "Ладно."

# game/bryce1.rpy:1061
translate russiantl _call_syscheck_41_76634173:
    ...
    m "К этому моменту, у меня уже были проблемы с тем, чтобы поднять стакан. Были мысли о том, чтобы сдаться, но в то же время уверенность, что осталось продержаться всего один раунд. Всё ещё можно победить. Я делал остановку после каждого глотка, но не сдался, и стакан потихоньку опустел."
...
translate russiantl _call_syscheck_41_c1731578:
    ...
    Br "Ты миленький... ты мне нравишься, но чёрт побери, я не позволю тебе победить."
...
translate russiantl _call_syscheck_41_b79117b3:
    ...
    m "Я почувствовал сонливость. Я слышал голос Брайса, но не мог понять, что он говорит. Я решил дать глазам отдохнуть, всего секундочку..."

# game/bryce1.rpy:1103
translate russiantl _call_syscheck_41_690f24fc:

    # Br "Hey, are you okay? You fell down, and you look kinda messed up."
    Br "Эй, ты в порядке? Ты упал и выглядишь неважно."

# game/bryce1.rpy:1113
translate russiantl _call_syscheck_41_4d0fcc3c:
...
translate russiantl _call_syscheck_41_c47af806:

    # Br "Ready for another round? Or do you give up?"
    Br "Так что, начинаем следующий раунд? Или сдаёшься?"

# game/bryce1.rpy:1137
translate russiantl _call_syscheck_41_da60aaef:

    # Br "Actually, you know... once you're lying on the ground, you better stop."
    Br "Знаешь... если ты уже валяешься на полу, то лучше остановиться."

# game/bryce1.rpy:1138
translate russiantl _call_syscheck_41_336474fe:

    # c "Does that mean I win?"
    c "Значит я победил?"

# game/bryce1.rpy:1140
translate russiantl _call_syscheck_41_d96fe527:

    # Br "I didn't say that."
    Br "Я этого не говорил."
...
translate russiantl _call_syscheck_41_fdd3ae60:
    ...
    Br "Ну, ты хотя бы достойно соревновался. Не думал, что человек на такое способен."

# game/bryce1.rpy:1157
translate russiantl _call_syscheck_41_9c03c7d6:
    ...
    Wr "Знаете, было конечно весело наблюдать за вами, но мне кажется, что вам обоим на сегодня уже хватит. Лучше расходитесь по домам. Ну, как только сможете вылезти из-под стола."

# game/bryce1.rpy:1163
translate russiantl _call_syscheck_41_e4584ec6:

    # c "Alright. I'll be going, then."
    c "Ну ладно, я тогда пойду."

# game/bryce1.rpy:1164
translate russiantl _call_syscheck_41_a75fc399:

    # Wr "Wait a minute."
    Wr "Минуточку."

# game/bryce1.rpy:1165
translate russiantl _call_syscheck_41_a626050d:

    # c "What... is it?"
    c "Что... такое?"

# game/bryce1.rpy:1166
translate russiantl _call_syscheck_41_940aaa96:
    ...
    Wr "Тебе стоит проводить его до дома, чтобы удостовериться, что он не натворит ничего глупого по пути. Это что-то вроде негласного правила этого бара: кто пьёт с ним, тот и ведёт его домой."

# game/bryce1.rpy:1167
translate russiantl _call_syscheck_41_d60a7e05:

    # m "When I looked over to him, I discovered that Bryce had passed out for the moment. This could prove difficult."
    m "Когда я посмотрел на него, то увидел, что Брайс начинает дремать. Вряд ли будет просто дотащить его до дома."

# game/bryce1.rpy:1172
translate russiantl _call_syscheck_41_1f6d21c9:

    # Wr "Thank you."
    Wr "Спасибо за понимание."

# game/bryce1.rpy:1175
translate russiantl _call_syscheck_41_3572097d:

    # Wr "You'll be doing yourself a favor, too."
    Wr "На самом деле ты себе же оказываешь услугу."

# game/bryce1.rpy:1178
translate russiantl _call_syscheck_41_0fcb5e2a:

    # c "Heck, no."
    c "Чёрта с два."

# game/bryce1.rpy:1179
translate russiantl _call_syscheck_41_f5524811:

    # Wr "That's not very nice of you."
    Wr "Знаешь, это не очень вежливо."

# game/bryce1.rpy:1180
translate russiantl _call_syscheck_41_47c56494:

    # c "Get outta my way, you scaly sack, before I show you how nice I can be... with my fists!"
    c "Уйди с дороги, ты, чешуйчатый носок, пока я не показал тебе вежливость... кулаком по роже!"

# game/bryce1.rpy:1182
translate russiantl _call_syscheck_41_76b2fe88_2:

    # nvl clear
    nvl clear

# game/bryce1.rpy:1184
translate russiantl _call_syscheck_41_76f5806b:

    # n "Without looking back, I got up and stumbled back to my apartment on shaky legs."
    n "Я встал и без оглядки пошёл домой, еле держась на ногах."

# game/bryce1.rpy:1185
translate russiantl _call_syscheck_41_c58a4f78:

    # n "When I finally arrived, I was glad to fall into bed and sleep away the whole evening."
    n "Когда я наконец прибыл, я был счастлив наконец упасть на кровать и уснуть."

# game/bryce1.rpy:1187
translate russiantl _call_syscheck_41_76b2fe88_3:

    # nvl clear
    nvl clear

# game/bryce1.rpy:1212
translate russiantl _call_syscheck_41_4545410c:

    # c "Come on, let's get you home."
    c "Вставай, пойдём домой."
...
translate russiantl _call_syscheck_41_49835fc5:
    ...
    c "Всё ещё в баре. Давай, пойдём домой."

# game/bryce1.rpy:1227
translate russiantl _call_syscheck_41_073b0378:

    # c "Wake up. Wake up. Wake uuuuuuup!"
    c "Вставай. Вставай. Вставааааай!"

# game/bryce1.rpy:1229
translate russiantl _call_syscheck_41_42cdb000:

    # Br "What? Is that you, [player_name]?"
    Br "Что? Это ты, [player_name]?"

# game/bryce1.rpy:1233
translate russiantl _call_syscheck_41_c8bba8fd:

    # Br "Stop it! I'm awake already."
    Br "Прекрати! Я уже проснулся."

# game/bryce1.rpy:1234
translate russiantl _call_syscheck_41_bc30dece:

    # c "Sorry."
    c "Прости."

# game/bryce1.rpy:1236
translate russiantl _call_syscheck_41_a287ee97:

    # Br "Where am I?"
    Br "Где я?"

# game/bryce1.rpy:1237
translate russiantl _call_syscheck_41_46f9c800:

    # c "Still in the bar."
    c "Всё ещё в баре."

# game/bryce1.rpy:1239
translate russiantl _call_syscheck_41_e3d2aa39:

    # Br "Ugh..."
    Br "Мееех..."

# game/bryce1.rpy:1240
translate russiantl _call_syscheck_41_25c5b01b:

    # c "Come on. Let's get you home, you big wuss."
    c "Давай. Пойдём домой, слабачок."

# game/bryce1.rpy:1244
translate russiantl _call_syscheck_41_d59f28e4:

    # c "(Right, it'll be like a smelling salt.)"
    c "(Так, ну, раз нет нашатыря, будем действовать подручными средствами.)"

# game/bryce1.rpy:1247
translate russiantl _call_syscheck_41_c86418be:

    # c "(Huh... that was actually the salt, not the pepper. Let's try that again.)"
    c "(Ой... это соль, а не перец. Ну ничего, сейчас исправим.)"

# game/bryce1.rpy:1251
translate russiantl _call_syscheck_41_38cdd69e:

    # Br "What? Is that you, [player_name]? Where am I?"
    Br "Что? Это ты, [player_name]? Где я?"

# game/bryce1.rpy:1254
translate russiantl _call_syscheck_41_c0184757:

    # Br "And what did you do to my nose? Did you shove something in there while I was out or something?"
    Br "И что ты сделал с моим носом? Ты что, туда что-то засунул, пока я спал?"
...
translate russiantl _call_syscheck_41_98f47339:
    ...
    Br "А получше не мог чего-нибудь придумать?"

# game/bryce1.rpy:1257
translate russiantl _call_syscheck_41_3995e8a3:

    # c "I'm drunk, what'd you expect?"
    c "Я в стельку, чего ты ожидал?"

# game/bryce1.rpy:1258
translate russiantl _call_syscheck_41_d7f0d77a:

    # Br "Oh, shut up."
    Br "Ой, да ну тебя."

# game/bryce1.rpy:1259
translate russiantl _call_syscheck_41_25c5b01b_1:
...
translate russiantl _call_syscheck_41_61f333a7:

    # m "The dragon moved and let out a groan before he opened his eyes."
    m "Дракон зашевелился и зевнул, прежде чем открыть глаза."

# game/bryce1.rpy:1283
translate russiantl _call_syscheck_41_fc6ce294:

    # Br "Just as you do, occasionally, I bet."
    Br "Как будто у тебя такого не бывает."

# game/bryce1.rpy:1287
translate russiantl _call_syscheck_41_61f333a7_1:

    # m "The dragon moved and let out a groan before he opened his eyes."
    m "Дракон зашевелился и зевнул, прежде чем открыть глаза."

# game/bryce1.rpy:1292
translate russiantl _call_syscheck_41_9b29c307:

    # c "(That got him.)"
    c "(Похоже, это его задело.)"

# game/bryce1.rpy:1293
translate russiantl _call_syscheck_41_2445b0f7:

    # Br "For your information, my kind does tend to look a little bigger than the others, but it also makes us the strongest."
    Br "К твоему сведенью, мой вид не только выглядит крупнее других, он ещё и сильнее."

# game/bryce1.rpy:1298
translate russiantl _call_syscheck_41_61f333a7_2:
...
translate russiantl _call_syscheck_41_59eeaffb:
    ...
    c "Наверно, я вырубился как только довёл тебя до дома."

# game/bryce1.rpy:1309
translate russiantl _call_syscheck_41_470e285c:

    # Br "Oh right, after our little game."
    Br "Ах да, мы же играли в ту самую игру."

# game/bryce1.rpy:1310
translate russiantl _call_syscheck_41_bc8c7852:

    # c "Do you remember who won?"
    c "Не помнишь, кто победил?"
...
translate russiantl _call_syscheck_41_dcc4839f:
    ...
    m "Дракон встал с дивана, потянулся, протёр глаза и снова зевнул."

# game/bryce1.rpy:1327
translate russiantl _call_syscheck_41_9a1e394a:

    # Br "That whole contest was stupid."
    Br "Это соревнование было глупостью."

# game/bryce1.rpy:1328
translate russiantl _call_syscheck_41_d9e78669:

    # c "Well, it was your idea."
    c "Ну, это была твоя идея."

# game/bryce1.rpy:1330
translate russiantl _call_syscheck_41_51787622:

    # Br "At least I knew when to stop."
    Br "Я хотя бы знал, когда надо остановиться."
...
translate russiantl _call_syscheck_41_6b561738:
    ...
    c "Ну, ты бы мог. Знаешь, моё положение посла не позволило бы мне отказаться от встречи с такой важной шишкой."
...
translate russiantl _call_syscheck_41_e7cca4c5:
    ...
    Br "Знаешь что? Иди-ка ты лучше домой."

# game/bryce1.rpy:1341
translate russiantl _call_syscheck_41_5b5c16d4:

    # c "Yeah, I guess I should."
    c "Да, пожалуй, мне пора."

# game/bryce1.rpy:1369
translate russiantl bryce1skip_97c9b7f4:
    ...
    Br "Ладно, знаешь что? Прости. Всё это соревнование было глупой идеей, мне не стоило её предлагать, особенно тебе."

# game/bryce1.rpy:1370
translate russiantl bryce1skip_b97488ce:

    # c "Well, it's not like you forced me to participate, so I suppose I share some of the blame..."
    c "Ну, не то, чтобы ты заставил меня участвовать, так что часть вины лежит и на мне..."

# game/bryce1.rpy:1372
translate russiantl bryce1skip_3ffd6748:

    # Br "Let's just pretend the whole thing never happened."
    Br "Давай просто притворимся, что ничего этого не было."
...
translate russiantl bryce1skip_0584cbbe:
    ...
    Br "Погоди... а который сейчас час?"

# game/bryce1.rpy:1376
translate russiantl bryce1skip_9b9ab1ee:
...
translate russiantl bryce1skip_c38f9204:

    # Br "Guess you should be going as well, kiddo. Maybe I'll see you some other time."
    Br "Наверно, и тебе уже пора заняться своими делами. Ещё увидимся."

# game/bryce1.rpy:1406
translate russiantl bryce1skip_97c9b7f4_1:

    # Br "Alright, you know what? I'm sorry. The whole contest thing was a stupid idea and I shouldn't have suggested it, especially not to you."
    Br "Ладно, знаешь что? Прости. Всё это соревнование было глупой идеей, мне не стоило её предлагать, особенно тебе."

# game/bryce1.rpy:1407
translate russiantl bryce1skip_b97488ce_1:

    # c "Well, it's not like you forced me to participate, so I suppose I share some of the blame..."
    c "Ну, не то, чтобы ты заставил меня участвовать, так что часть вины лежит и на мне..."

# game/bryce1.rpy:1409
translate russiantl bryce1skip_3ffd6748_1:
...
translate russiantl bryce1skip_70fb6772:
    ...
    c "Но как же мы тогда узнаем, кто победил, если не продолжим соревнование?"
...
translate russiantl strings:
    ...
    new "[[надавить на него из-за его порывов пойти в бар]"
    ...
    new "Это наверняка не так и сложно."
    ...
    new "Пока ничего. Может, потом что-нибудь закажу."
    ...
    new "Уж лучше я проведу это время дома за чтением."
    ...
    new "Вообще-то я обычно не пью."

    # bryce1.rpy:417
    old "I'll try it just for you."
    new "Я попробую только ради тебя."
    ...
    new "Не думаю, что смогу победить кого-то вроде тебя."
    ...
    new "Вот тут ты просчитался. Я никогда не сдаюсь."
    ...
    new "Сначала посмотрим, как ты выступишь."

    # bryce1.rpy:859
    old "That's my tactic, make you think that I'm struggling so you'll let your guard down."
    new "Это моя тактика. Я заставлю тебя думать, что мне плохо, и тогда ты потеряешь бдительность."

    # bryce1.rpy:859
    old "I may have underestimated this..."
    new "Наверно, я переоценил свои силы..."
    ...
    new "Ну, иметь друзей наверху не так уж и плохо."
    ...
    new "Т-ты не говорил, что есть такое правило."
    ...
    new "Ты сам будешь выглядеть неважно, если не отстанешь."

    # bryce1.rpy:1109
    old "If you think I'm giving up, you're mistaken. This isn't over."
    new "Если ты думаешь, что я сдаюсь, то ошибаешься. Ничего ещё не окончено."
    ...
    new "Я думаю... что мне хватит."

    # bryce1.rpy:1132
    old "I know when I've had enough, and it's now."
    new "Я знаю, когда стоит остановиться, и этот момент настал."
    ...
    # bryce1.rpy:1169
    old "If I have to..."
    new "Ну, если так надо..."

    # bryce1.rpy:1214
    old "Dump some water on his face."
    new "Вылить стакан воды ему на лицо."
